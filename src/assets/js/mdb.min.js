...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    return function (t, e, i, n) {
          ...
          C = function (e) {
            return k || h(), t === i && n === o ? e : 0 === e ? 0 : 1 === e ? 1 : l(function (e) {
              ...
              var r = i + (e - w[--o]) / (w[o + 1] - w[o]) * y,
                s = c(r, t, n);
              return s >= p ? u(e, r) : 0 == s ? r : d(e, i, i + y)
            }(e), i, o)
          };
      ...
      function s(t, e) {
        ...
        }.apply(null, t) : f.isArray(t) && 2 === t.length ? y.apply(null, t.concat([e])) : !(!f.isArray(t) || 4 !== t.length) && r.apply(null, t), !1 === i && (i = v.Easings[v.defaults.easing] ? v.defaults.easing : g), i
      }
            ...
            if (v.State.calls[o]) {
              ...
              for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                ...
                if (a(C)) {
                  ...
                  for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k)
                    if ("element" !== T) {
                      var M, I = k[T],
                        P = f.isString(I.easing) ? v.Easings[I.easing] : I.easing;
                      if (1 === g) M = I.endValue;
                      else {
                        var A = I.endValue - I.startValue;
                        if (M = I.startValue + A * P(g, d, A), !p && M === I.currentValue) continue
                      }
                      if (I.currentValue = M, "tween" === T) m = M;
                      else {
                        if (b.Hooks.registered[T]) {
                          var D = b.Hooks.getRoot(T),
                            _ = a(C).rootPropertyValueCache[D];
                          _ && (I.rootPropertyValue = _)
                        }
                        var E = b.setPropertyValue(C, T, I.currentValue + (0 === parseFloat(M) ? "" : I.unitType), I.rootPropertyValue, I.scrollData);
                        b.Hooks.registered[T] && (a(C).rootPropertyValueCache[D] = b.Normalizations.registered[D] ? b.Normalizations.registered[D]("extract", null, E[1]) : E[1]), "transform" === E[0] && (S = !0)
                      }
                    }
      ...
      function c(t, e) {
        ...
        for (var i = v.State.calls[t][0], o = v.State.calls[t][1], r = v.State.calls[t][2], s = v.State.calls[t][4], l = !1, c = 0, d = i.length; d > c; c++) {
          ...
          if (e || r.loop || ("none" === r.display && b.setPropertyValue(h, "display", r.display), "hidden" === r.visibility && b.setPropertyValue(h, "visibility", r.visibility)), !0 !== r.loop && (u.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(u.queue(h)[1])) && a(h)) {
            ...
            u.each(b.Lists.transforms3D, function (t, e) {
              ...
              a(h).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(o) && (f = !0, delete a(h).transformCache[e])
            }), r.mobileHA && (f = !0, delete a(h).transformCache.translate3d), f && b.flushTransformCache(h), b.Values.removeClass(h, "velocity-animating")
          }
        ...
        v.State.calls[t] = !1;
        for (var p = 0, m = v.State.calls.length; m > p; p++)
      ...
      var u, d = function () {
        ...
        p = !1;
      if (t.fn && t.fn.jquery ? (u = t, p = !0) : u = e.Velocity.Utilities, 8 >= d && !p) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
      if (!(7 >= d)) {
        var m = 400,
          g = "swing",
          v = {
        ...
        var b = v.CSS = {
            ...
            prefixCheck: function (t) {
              ...
              for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
                ...
                if (o = 0 === i ? t : e[i] + t.replace(/^\w/, function (t) {
                  ...
                  }), f.isString(v.State.prefixElement.style[o])) return v.State.prefixMatches[t] = o, [o, !0]
              }
              return [t, !1]
            }
          },
          ...
          getPropertyValue: function (t, i, o, r) {
              ...
              if (8 >= d) l = u.css(t, i);
                ...
                if (/^(width|height)$/.test(i) && 0 === b.getPropertyValue(t, "display") && (h = !0, b.setPropertyValue(t, "display", b.Values.getDisplayType(t))), !r) {
                  if ("height" === i && "border-box" !== b.getPropertyValue(t, "boxSizing").toString().toLowerCase()) {
                    var f = t.offsetHeight - (parseFloat(b.getPropertyValue(t, "borderTopWidth")) || 0) - (parseFloat(b.getPropertyValue(t, "borderBottomWidth")) || 0) - (parseFloat(b.getPropertyValue(t, "paddingTop")) || 0) - (parseFloat(b.getPropertyValue(t, "paddingBottom")) || 0);
                    return o(), f
                  }
            ...
            if (b.Hooks.registered[i]) {
              ...
              var f, p;
              "transform" !== (f = b.Normalizations.registered[i]("name", t)) && (p = s(t, b.Names.prefixCheck(f)[0]), b.Values.isCSSNullValue(p) && b.Hooks.templates[i] && (p = b.Hooks.templates[i][1])), l = b.Normalizations.registered[i]("extract", t, p)
            }
            if (!/^[\d-]/.test(l))
        ...
        var x = function () {
            ...
            function t(t) {
              function h(t, e) {
                var i = n,
                  o = n,
                  a = n;
                return f.isArray(t) ? (i = t[0], !f.isArray(t[1]) && /^[\d-]/.test(t[1]) || f.isFunction(t[1]) || b.RegEx.isHex.test(t[1]) ? a = t[1] : (f.isString(t[1]) && !b.RegEx.isHex.test(t[1]) || f.isArray(t[1])) && (o = e ? t[1] : s(t[1], c.duration), t[2] !== n && (a = t[2]))) : i = t, e || (o = o || c.easing), f.isFunction(i) && (i = i.call(r, S, C)), f.isFunction(a) && (a = a.call(r, S, C)), [i || 0, o, a]
              }
              ...
              if ("scroll" === M) {
                var x, k, T, P = /^x$/i.test(c.axis) ? "Left" : "Top",
                  A = parseFloat(c.offset) || 0;
                c.container ? f.isWrapped(c.container) || f.isNode(c.container) ? (c.container = c.container[0] || c.container, T = (x = c.container["scroll" + P]) + u(r).position()[P.toLowerCase()] + A) : c.container = null : (x = v.State.scrollAnchor[v.State["scrollProperty" + P]], k = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === P ? "Top" : "Left")]], T = u(r).offset()[P.toLowerCase()] + A), d = {
                  scroll: {
                    rootPropertyValue: !1,
                    startValue: x,
                    currentValue: x,
                ...
                var D = u.extend(!0, {}, a(r).tweensContainer);
                for (var _ in D)
                  if ("element" !== _) {
                    var E = D[_].startValue;
                    D[_].startValue = D[_].currentValue = D[_].endValue, D[_].endValue = E, f.isEmptyObject(w) || (D[_].easing = c.easing), v.debug && console.log("reverse tweensContainer (" + _ + "): " + JSON.stringify(D[_]), r)
                  }
                d = D
              } else if ("start" === M) {
                for (var O in a(r).tweensContainer && !0 === a(r).isAnimating && (D = a(r).tweensContainer), u.each(y, function (t, e) {
                  ...
                  var N = b.Hooks.getRoot(O),
                    H = !1;
                  if (a(r).isSVG || "tween" === N || !1 !== b.Names.prefixCheck(N)[1] || b.Normalizations.registered[N] !== n) {
                    (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(O) && !z && 0 !== W && (z = 0), c._cacheValues && D && D[O] ? (z === n && (z = D[O].endValue + D[O].unitType), H = a(r).rootPropertyValueCache[N]) : b.Hooks.registered[O] ? z === n ? (H = b.getPropertyValue(r, N), z = b.getPropertyValue(r, O, H)) : H = b.Hooks.templates[N][1] : z === n && (z = b.getPropertyValue(r, O));
                    var B, j, Y, $ = !1;
                    if (z = (B = p(O, z))[0], Y = B[1], W = (B = p(O, W))[0].replace(/^([+-\/*])=/, function (t, e) {
                        return $ = e, ""
                      }), j = B[1], z = parseFloat(z) || 0, W = parseFloat(W) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (W /= 100, j = "em") : /^scale/.test(O) ? (W /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (W = W / 100 * 255, j = "")), /[\/*]/.test($)) j = Y;
                    else if (Y !== j && 0 !== z)
                      if (0 === W) j = Y;
                      else {
                        o = o || m();
                        ...
                        switch (Y) {
                          case "%":
                            z *= "x" === X ? o.percentToPxWidth : o.percentToPxHeight;
                            break;
                          case "px":
                            break;
                          default:
                        ...
                        switch (j) {
                          case "%":
                            z *= 1 / ("x" === X ? o.percentToPxWidth : o.percentToPxHeight);
                            break;
                          case "px":
                            break;
                          default:
                    ...
                    d[O] = {
                      ...
                      unitType: j,
                      easing: V
                    }, v.debug && console.log("tweensContainer (" + O + "): " + JSON.stringify(d[O]), r)
                  } else v.debug && console.log("Skipping [" + N + "] due to a lack of browser support.")
                }
                d.element = r
              }
              d.element && (b.Values.addClass(r, "velocity-animating"), R.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, S === C - 1 ? (v.State.calls.push([R, g, c, null, I.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : S++)
            }
            var o, r = this,
          ...
          var d, h, p, g, y, w, k = arguments[0] && (arguments[0].p || u.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || f.isString(arguments[0].properties));
          if (f.isWrapped(this) ? (d = !1, p = 0, g = this, h = this) : (d = !0, p = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                ...
                return u.each(v.State.calls, function (t, e) {
                  e && u.each(e[1], function (i, o) {
                    ...
                    return !0 !== r && e[2].queue !== r && (w !== n || !1 !== e[2].queue) || void u.each(g, function (i, n) {
                      n === o && ((!0 === w || f.isString(w)) && (u.each(u.queue(n, f.isString(w) ? w : ""), function (t, e) {
                        f.isFunction(e) && e(null, !0)
                      }), u.queue(n, f.isString(w) ? w : "", [])), "stop" === y ? (a(n) && a(n).tweensContainer && !1 !== r && u.each(a(n).tweensContainer, function (t, e) {
              ...
              default:
                if (!u.isPlainObject(y) || f.isEmptyObject(y)) {
                  if (f.isString(y) && v.Redirects[y]) {
                    var A = (O = u.extend({}, w)).duration,
                      D = O.delay || 0;
                    return !0 === O.backwards && (g = u.extend(!0, [], g).reverse()), u.each(g, function (t, e) {
                      parseFloat(O.stagger) ? O.delay = D + parseFloat(O.stagger) * t : f.isFunction(O.stagger) && (O.delay = D + O.stagger.call(e, t, C)), O.drag && (O.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1e3 : m), O.duration = Math.max(O.duration * (O.backwards ? 1 - t / C : (t + 1) / C), .75 * O.duration, 200)), v.Redirects[y].call(e, e, O || {}, t, C, g, I.promise ? I : n)
                    }), t()
                  }
            ...
            if (u.each(g, function (t, e) {
                f.isNode(e) && r.call(e)
              }), (O = u.extend({}, v.defaults, w)).loop = parseInt(O.loop), E = 2 * O.loop - 1, O.loop)
              for (var F = 0; E > F; F++) {
                var W = {
                  delay: O.delay,
                  progress: O.progress
                };
                F === E - 1 && (W.display = O.display, W.visibility = O.visibility, W.complete = O.complete), x(g, "reverse", W)
              }
            return t()
          }
        };
    ...
    return function () {
      ...
      4: [function (t, e, i) {
        ...
        var S = {
          ...
          T = {};
        for (var M in S) T[JSON.stringify(S[M])] = M
      }, {}],
      5: [function (t, e, i) {
        var n = t(4),
          o = function () {
          ...
          t.controllers.bar = t.DatasetController.extend({
            ...
            calculateBarValuePixels: function (t, e) {
              ...
              if (f || void 0 === f && void 0 !== p)
                for (i = 0; i < t; ++i)(n = l.getDatasetMeta(i)).bar && n.stack === p && n.controller.getValueScaleId() === u.id && l.isDatasetVisible(i) && (o = u.getRightValue(d[i].data[e]), (h < 0 && o < 0 || h >= 0 && o > 0) && (m += o));
            ...
            update: function (t) {
              ...
              if (f < 2 * Math.PI) {
                var p = o.rotation % (2 * Math.PI),
                  ...
                  y = p <= 0 && m >= 0 || p <= 2 * Math.PI && 2 * Math.PI <= m,
        ...
        n._set("line", {
          ...
          t.controllers.line = t.DatasetController.extend({
            ...
            updateElement: function (t, e, i) {
              ...
              void 0 !== c.radius && void 0 === c.pointRadius && (c.pointRadius = c.radius), void 0 !== c.hitRadius && void 0 === c.pointHitRadius && (c.pointHitRadius = c.hitRadius), n = f.getPixelForValue("object" == typeof d ? d : NaN, e, u), o = i ? h.getBasePixel() : r.calculatePointY(d, e, u), t._xScale = f, t._yScale = h, t._datasetIndex = u, t._index = e, t._model = {
                x: n,
                y: o,
                skip: l.skip || isNaN(n) || isNaN(o),
                radius: l.radius || a.valueAtIndexOrDefault(c.pointRadius, e, p.radius),
                pointStyle: l.pointStyle || a.valueAtIndexOrDefault(c.pointStyle, e, p.pointStyle),
                backgroundColor: r.getPointBackgroundColor(t, e),
                borderColor: r.getPointBorderColor(t, e),
                borderWidth: r.getPointBorderWidth(t, e),
                tension: s.dataset._model ? s.dataset._model.tension : 0,
                steppedLine: !!s.dataset._model && s.dataset._model.steppedLine,
                hitRadius: l.hitRadius || a.valueAtIndexOrDefault(c.pointHitRadius, e, p.hitRadius)
              }
            },
            ...
            draw: function () {
              var t = this.chart,
                ...
                r = n.length,
                s = 0;
              for (a.canvas.clipArea(t.ctx, o), e(this.getDataset(), t.options) && i.dataset.draw(), a.canvas.unclipArea(t.ctx); s < r; ++s) n[s].draw(o)
            },
            setHoverStyle: function (t) {
              var e = this.chart.data.datasets[t._datasetIndex],
                i = t._index,
            ...
            removeHoverStyle: function (t) {
              var e = this,
                ...
                o = t.custom || {},
                r = t._model;
              void 0 !== i.radius && void 0 === i.pointRadius && (i.pointRadius = i.radius), r.radius = o.radius || a.valueAtIndexOrDefault(i.pointRadius, n, e.chart.options.elements.point.radius), r.backgroundColor = e.getPointBackgroundColor(t, n), r.borderColor = e.getPointBorderColor(t, n), r.borderWidth = e.getPointBorderWidth(t, n)
            }
          })
        }
      }, {
      ...
      19: [function (t, e, i) {
        ...
        n._set("polarArea", {
          ...
          t.controllers.polarArea = t.DatasetController.extend({
            ...
            updateElement: function (t, e, i) {
              for (var n = this, o = n.chart, r = n.getDataset(), s = o.options, l = s.animation, c = o.scale, u = o.data.labels, d = n.calculateCircumference(r.data[e]), h = c.xCenter, f = c.yCenter, p = 0, m = n.getMeta(), g = 0; g < e; ++g) isNaN(r.data[g]) || m.data[g].hidden || ++p;
              var v = s.startAngle,
          ...
          t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
            construct: function (e, i) {
              ...
              i = function (t) {
                ...
                return e.datasets = e.datasets || [], e.labels = e.labels || [], t.options = o.configMerge(n.global, n[t.type], t.options || {}), t
              }(i);
              var r = s.acquireContext(e, i),
                l = r && r.canvas,
                c = l && l.height,
                u = l && l.width;
              a.id = o.uid(), a.ctx = r, a.canvas = l, a.config = i, a.width = u, a.height = c, a.aspectRatio = c ? u / c : null, a.options = i.options, a._bufferedRender = !1, a.chart = a, a.controller = a, t.instances[a.id] = a, Object.defineProperty(a, "data", {
                get: function () {
              ...
              }), r && l ? (a.initialize(), a.update()) : console.error("Failed to create chart: can't acquire context from the given item")
            },
            initialize: function () {
              var t = this;
              return l.notify(t, "beforeInit"), o.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.initToolTip(), l.notify(t, "afterInit"), t
            },
            clear: function () {
            ...
            resize: function (t) {
              ...
              if ((e.width !== r || e.height !== s) && (n.width = e.width = r, n.height = e.height = s, n.style.width = r + "px", n.style.height = s + "px", o.retinaScale(e, i.devicePixelRatio), !t)) {
                ...
                l.notify(e, "resize", [c]), e.options.onResize && e.options.onResize(e, c), e.stop(), e.update(e.options.responsiveAnimationDuration)
              }
            },
            ...
            buildOrUpdateScales: function () {
              ...
              n.scales && (r = r.concat((n.scales.xAxes || []).map(function (t) {
                ...
                var u = null;
                if (l in a && a[l].type === c)(u = a[l]).options = r, u.ctx = i.ctx, u.chart = i;
                else {
                ...
                t || delete a[e]
              }), i.scales = a, t.scaleService.addScalesToLayout(this)
            },
            ...
            update: function (e) {
              ...
              if (e && "object" == typeof e || (e = {
                  ...
                  r.removeBox(i, t)
                }), n = o.configMerge(t.defaults.global, t.defaults[i.config.type], n), i.options = i.config.options = n, i.ensureScalesHaveIDs(), i.buildOrUpdateScales(), i.tooltip._options = n.tooltips, i.tooltip.initialize(), l._invalidate(a), !1 !== l.notify(a, "beforeUpdate")) {
                ...
                }, a), a.updateLayout(), a.options.animation && a.options.animation.duration && o.each(s, function (t) {
                  t.reset()
            ...
            render: function (e) {
              ...
              if (!1 !== l.notify(i, "beforeRender")) {
                var r = i.options.animation,
                  s = function (t) {
                    l.notify(i, "afterRender"), o.callback(r && r.onComplete, [t], i)
                  };
            ...
            draw: function (t) {
              var e = this;
              e.clear(), o.isNullOrUndef(t) && (t = 1), e.transition(t), !1 !== l.notify(e, "beforeDraw", [t]) && (o.each(e.boxes, function (t) {
                t.draw(e.chartArea)
            ...
            destroy: function () {
              ...
              a && (n.unbindEvents(), o.canvas.clear(n), s.releaseContext(n.ctx), n.canvas = null, n.ctx = null), l.notify(n, "destroy"), delete t.instances[n.id]
            },
        ...
        o.extend(a.prototype, {
          ...
          transition: function (t) {
            ...
            return i && 1 !== t ? (a || (a = e._view = {}), o || (o = e._start = {}), function (t, e, i, o) {
              var a, r, s, l, c, u, d, h, f, p = Object.keys(i);
      ...
      27: [function (t, e, i) {
        ...
        e.exports = function (t) {
          ...
          a.configMerge = function () {
            ...
            return a.merge(a.clone(arguments[0]), [].slice.call(arguments, 1), {
              merger: function (e, i, n, o) {
                if ("xAxes" === e || "yAxes" === e) {
                  ...
                  for (i[e] || (i[e] = []), r = 0; r < c; ++r) l = n[e][r], s = a.valueOrDefault(l.type, "xAxes" === e ? "category" : "linear"), r >= i[e].length && i[e].push({}), !i[e][r].type || l.type && l.type !== i[e][r].type ? a.merge(i[e][r], [t.scaleService.getScaleDefaults(s), l]) : a.merge(i[e][r], l)
                } else a._merger(e, i, n, o)
              }
            })
            ...
            return {
              x: i = Math.round((i - s.left - c) / f * r.width / e.currentDevicePixelRatio),
        ...
        e.exports = {
          ...
          update: function (t, e, i) {
            if (t) {
              ...
              a(h, !0), a(f, !1), a(p, !0), a(m, !1);
              var v = e - l - c,
                y = i - u - d,
                b = y / 2,
                x = (e - v / 2) / (h.length + f.length),
                w = (i - b) / (p.length + m.length),
                k = v,
                C = y,
                S = [];
              n.each(h.concat(f, p, m), function (t) {
              ...
              var A = l,
                ...
                _ = u,
                E = d;
              n.each(h.concat(f), z), n.each(h, function (t) {
                A += t.width
              }), n.each(f, function (t) {
                D += t.width
              }), n.each(p.concat(m), z), n.each(p, function (t) {
                _ += t.height
              }), n.each(m, function (t) {
                E += t.height
              }), n.each(h.concat(f), function (t) {
              ...
              }), A = l, D = c, _ = u, E = d, n.each(h, function (t) {
                A += t.width
              }), n.each(f, function (t) {
                D += t.width
              }), n.each(p, function (t) {
              ...
              var O = Math.max(T - A, 0);
              A += O, D += Math.max(M - D, 0);
              var L = Math.max(I - _, 0);
              _ += L, E += Math.max(P - E, 0);
              var R = i - _ - E,
                F = e - A - D;
              F === k && R === C || (n.each(h, function (t) {
                t.height = R
              }), n.each(f, function (t) {
                t.height = R
              }), n.each(p, function (t) {
              ...
              var W = l + O,
                V = u + L;
              n.each(h.concat(p), N), W += k, V += C, n.each(f, N), n.each(m, N), t.chartArea = {
                left: A,
                top: _,
                right: A + k,
                bottom: _ + C
            ...
            function N(t) {
              t.isHorizontal() ? (t.left = t.fullWidth ? l : A, t.right = t.fullWidth ? e - c : A + k, t.top = V, t.bottom = V + t.height, V = t.bottom) : (t.left = W, t.right = W + t.width, t.top = _, t.bottom = _ + C, W = t.right)
            }
          }
        }
      }, {
        ...
        n._set("scale", {
          ...
          t.Scale = o.extend({
            ...
            calculateTickRotation: function () {
              ...
              if (o.length && t.options.display && t.isHorizontal())
                for (var c, u = a.longestText(e, r.font, o, t.longestTextCache), d = u, h = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; d > h && l < n.maxRotation;) {
                  var f = a.toRadians(l);
                  if (c = Math.cos(f), Math.sin(f) * u > t.maxHeight) {
                    l--;
                    break
                  }
                  l++, d = c * u
            ...
            fit: function () {
              ...
              if (n.width = f ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : h && d.drawTicks ? m : 0, n.height = f ? h && d.drawTicks ? m : 0 : t.maxHeight, u.display && h) {
                var g = r(u) + a.options.toPadding(u.padding).height;
                f ? n.height += g : n.width += g
              }
              if (c.display && h) {
                var v = a.longestText(t.ctx, p.font, o, t.longestTextCache),
                ...
                if (f) {
                  ...
                  n.height = Math.min(t.maxHeight, n.height + C + x), t.ctx.font = p.font;
                  var S = e(t.ctx, o[0], p.font),
                    T = e(t.ctx, o[o.length - 1], p.font);
                  0 !== t.labelRotation ? (t.paddingLeft = "bottom" === l.position ? k * S + 3 : k * b + 3, t.paddingRight = "bottom" === l.position ? k * b + 3 : k * T + 3) : (t.paddingLeft = S / 2 + 3, t.paddingRight = T / 2 + 3)
                } else c.mirror ? v = 0 : v += x + b, n.width = Math.min(t.maxWidth, n.width + v), t.paddingTop = p.size / 2, t.paddingBottom = p.size / 2
              }
            ...
            _autoSkip: function (t) {
              var e, i, n, o, r = this,
                ...
                f = [];
              for (l.maxTicksLimit && (o = l.maxTicksLimit), s && (e = !1, (h + l.autoSkipPadding) * c > r.width - (r.paddingLeft + r.paddingRight) && (e = 1 + Math.floor((h + l.autoSkipPadding) * c / (r.width - (r.paddingLeft + r.paddingRight)))), o && c > o && (e = Math.max(e, Math.floor(c / o)))), i = 0; i < c; i++) n = t[i], (e > 1 && i % e > 0 || i % e == 0 && i + e >= c) && i !== c - 1 && delete n.label, f.push(n);
              return f
            },
            draw: function (t) {
              var e = this,
              ...
              if (o.display) {
                var s = e.ctx,
                  ...
                  k = a.valueOrDefault(f.fontColor, c.defaultFontColor),
                  C = i(f),
                  S = a.options.toPadding(f.padding),
                  T = a.toRadians(e.labelRotation),
                  M = [],
                  I = e.options.gridLines.lineWidth,
                  P = "right" === o.position ? e.right : e.right - I - w,
                  A = "right" === o.position ? e.right + w : e.right,
                  D = "bottom" === o.position ? e.top + I : e.bottom - w - I,
                  _ = "bottom" === o.position ? e.top + I + w : e.bottom + I;
                if (a.each(g, function (i, n) {
                    if (!a.isNullOrUndef(i.label)) {
                      var r, s, d, f, v, y, b, x, k, C, S, E, O, L, R = i.label;
                      n === e.zeroLineIndex && o.offset === h.offsetGridLines ? (r = h.zeroLineWidth, s = h.zeroLineColor, d = h.zeroLineBorderDash, f = h.zeroLineBorderDashOffset) : (r = a.valueAtIndexOrDefault(h.lineWidth, n), s = a.valueAtIndexOrDefault(h.color, n), d = a.valueOrDefault(h.borderDash, c.borderDash), f = a.valueOrDefault(h.borderDashOffset, c.borderDashOffset));
                      var F = "middle",
                        W = "middle",
                        V = u.padding;
                      if (m) {
                        var z = w + V;
                        "bottom" === o.position ? (W = p ? "middle" : "top", F = p ? "right" : "center", L = e.top + z) : (W = p ? "middle" : "bottom", F = p ? "left" : "center", L = e.bottom - z);
                        var N = l(e, n, h.offsetGridLines && g.length > 1);
                        N < e.left && (s = "rgba(0,0,0,0)"), N += a.aliasPixel(r), O = e.getPixelForTick(n) + u.labelOffset, v = b = k = S = N, y = D, x = _, C = t.top, E = t.bottom + I
                      } else {
                        var H, B = "left" === o.position;
                        u.mirror ? (F = B ? "left" : "right", H = V) : (F = B ? "right" : "left", H = w + V), O = B ? e.right - H : e.left + H;
                        var j = l(e, n, h.offsetGridLines && g.length > 1);
                        j < e.top && (s = "rgba(0,0,0,0)"), j += a.aliasPixel(r), L = e.getPixelForTick(n) + u.labelOffset, v = P, b = A, k = t.left, S = t.right + I, y = x = C = E = j
                      }
                      M.push({
                        tx1: v,
                        ty1: y,
                    ...
                    if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), u.display) {
                      ...
                      var i = t.label;
                      if (a.isArray(i))
                        for (var n = i.length, o = 1.5 * y.size, r = e.isHorizontal() ? 0 : -o * (n - 1) / 2, l = 0; l < n; ++l) s.fillText("" + i[l], 0, r), r += o;
                  ...
                  var E, O, L = 0,
                    R = r(f) / 2;
                  if (m) E = e.left + (e.right - e.left) / 2, O = "bottom" === o.position ? e.bottom - R - S.bottom : e.top + R + S.top;
                  else {
                    var F = "left" === o.position;
                    E = F ? e.left + R + S.top : e.right - R - S.top, O = e.top + (e.bottom - e.top) / 2, L = F ? -.5 * Math.PI : .5 * Math.PI
                  }
                  s.save(), s.translate(E, O), s.rotate(L), s.textAlign = "center", s.textBaseline = "middle", s.fillStyle = k, s.font = C.font, s.fillText(f.labelString, 0, 0), s.restore()
                }
                if (h.drawBorder) {
                  ...
                  var W = e.left,
                    ...
                    z = e.top,
                    N = e.bottom + I,
                    H = a.aliasPixel(s.lineWidth);
                  m ? (z = N = "top" === o.position ? e.bottom : e.top, z += H, N += H) : (W = V = "left" === o.position ? e.right : e.left, W += H, V += H), s.beginPath(), s.moveTo(W, z), s.lineTo(V, N), s.stroke()
                }
              }
            }
          })
          ...
          t.Tooltip = o.extend({
            ...
            update: function (e) {
              ...
              if (m.length) {
                ...
                var C = [];
                for (i = 0, n = m.length; i < n; ++i) C.push((o = m[i], s = void 0, l = void 0, void 0, void 0, s = o._xScale, l = o._yScale || o._scale, c = o._index, u = o._datasetIndex, {
                ...
                h.filter && (C = C.filter(function (t) {
                ...
                }), p.title = d.getTitle(C, g), p.beforeBody = d.getBeforeBody(C, g), p.body = d.getBody(C, g), p.afterBody = d.getAfterBody(C, g), p.footer = d.getFooter(C, g), p.x = Math.round(x.x), p.y = Math.round(x.y), p.caretPadding = h.caretPadding, p.labelColors = w, p.labelTextColors = k, p.dataPoints = C, y = function (t, e, i, n) {
                  var o = t.x,
                    a = t.y,
                    r = t.caretSize,
                    s = t.caretPadding,
                  ...
                  return i.font = a.fontString(u, e._titleFontStyle, e._titleFontFamily), a.each(e.title, p), i.font = a.fontString(d, e._bodyFontStyle, e._bodyFontFamily), a.each(e.beforeBody.concat(e.afterBody), p), f = e.displayColors ? d + 2 : 0, a.each(r, function (t) {
                    a.each(t.before, p), a.each(t.lines, p), a.each(t.after, p)
                  }), f = 0, i.font = a.fontString(h, e._footerFontStyle, e._footerFontFamily), a.each(e.footer, p), {
            ...
            getCaretPosition: function (t, e, i) {
              var n, o, a, r, s, l, c = i.caretSize,
                ...
                m = e.width,
                g = e.height;
              if ("center" === h) s = p + g / 2, "left" === d ? (o = (n = f) - c, a = n, r = s + c, l = s - c) : (o = (n = f + m) + c, a = n, r = s - c, l = s + c);
              else if ("left" === d ? (n = (o = f + u + c) - c, a = o + c) : "right" === d ? (n = (o = f + m - u - c) - c, a = o + c) : (n = (o = i.caretX) - c, a = o + c), "top" === h) s = (r = p) - c, l = r;
              else {
                s = (r = p + g) + c, l = r;
                var v = a;
                a = n, n = v
            ...
            drawTitle: function (t, i, n, o) {
              ...
              if (r.length) {
                ...
                var s, l, c = i.titleFontSize,
                  u = i.titleSpacing;
                for (n.fillStyle = e(i.titleFontColor, o), n.font = a.fontString(c, i._titleFontStyle, i._titleFontFamily), s = 0, l = r.length; s < l; ++s) n.fillText(r[s], t.x, t.y), t.y += c + u, s + 1 === r.length && (t.y += i.titleMarginBottom - u)
              }
            },
            drawBody: function (t, i, n, o) {
              ...
              var c = 0,
                u = function (e) {
                  n.fillText(e, t.x + c, t.y), t.y += r + s
                };
              n.fillStyle = e(i.bodyFontColor, o), a.each(i.beforeBody, u);
              var d = i.displayColors;
              c = d ? r + 2 : 0, a.each(l, function (s, l) {
                var c = e(i.labelTextColors[l], o);
                n.fillStyle = c, a.each(s.before, u), a.each(s.lines, function (a) {
                  d && (n.fillStyle = e(i.legendColorBackground, o), n.fillRect(t.x, t.y, r, r), n.lineWidth = 1, n.strokeStyle = e(i.labelColors[l].borderColor, o), n.strokeRect(t.x, t.y, r, r), n.fillStyle = e(i.labelColors[l].backgroundColor, o), n.fillRect(t.x + 1, t.y + 1, r - 2, r - 2), n.fillStyle = c), u(a)
                }), a.each(s.after, u)
              }), c = 0, a.each(i.afterBody, u), t.y -= s
            },
            drawFooter: function (t, i, n, o) {
              var r = i.footer;
              r.length && (t.y += i.footerMarginTop, n.textAlign = i._footerAlign, n.textBaseline = "top", n.fillStyle = e(i.footerFontColor, o), n.font = a.fontString(i.footerFontSize, i._footerFontStyle, i._footerFontFamily), a.each(r, function (e) {
                n.fillText(e, t.x, t.y), t.y += i.footerFontSize + i.footerSpacing
              }))
            },
            drawBackground: function (t, i, n, o, a) {
              n.fillStyle = e(i.backgroundColor, a), n.strokeStyle = e(i.borderColor, a), n.lineWidth = i.borderWidth;
              var r = i.xAlign,
                s = i.yAlign,
                l = t.x,
                c = t.y,
          ...
          roundedRect: function (t, e, i, n, o, a) {
            if (a) {
              var r = Math.min(a, n / 2),
                s = Math.min(a, o / 2);
              t.moveTo(e + r, i), t.lineTo(e + n - r, i), t.quadraticCurveTo(e + n, i, e + n, i + s), t.lineTo(e + n, i + o - s), t.quadraticCurveTo(e + n, i + o, e + n - r, i + o), t.lineTo(e + r, i + o), t.quadraticCurveTo(e, i + o, e, i + o - s), t.lineTo(e, i + s), t.quadraticCurveTo(e, i, e + r, i)
            } else t.rect(e, i, n, o)
          },
        ...
        function m(t, e, i) {
          var c, u, d, f, m = t[o] || (t[o] = {}),
            g = m.resizer = function (t) {
              ...
              if (m.resizer) return e(p("resize", i))
            }, d = !1, f = [], function () {
      ...
      50: [function (t, e, i) {
        ...
        e.exports = {
          ...
          afterDatasetsUpdate: function (t, e) {
            ...
            for (n = 0; n < d; ++n)(r = f[n]) && (r.fill = c(f, n, h), r.boundary = l(r), r.mapper = u(r))
          },
          beforeDatasetDraw: function (t, e) {
            ...
            if (i) {
              ...
              c && u && l.length && (a.canvas.clipArea(o, t.chartArea), function (t, e, i, n, o, a) {
                var r, s, l, c, u, f, p, m = e.length,
                  g = n.spanGaps,
                  v = [],
                  y = [],
                  b = 0,
                  x = 0;
                for (t.beginPath(), r = 0, s = m + !!a; r < s; ++r) u = i(c = e[l = r % m]._view, l, n), f = d(c), p = d(u), f && p ? (b = v.push(c), x = y.push(u)) : b && x && (g ? (f && v.push(c), p && y.push(u)) : (h(t, v, y, b, x), b = x = 0, v = [], y = []));
            ...
            if (g ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o)
              if (r.font = f, g) {
                ...
                a.each(t.legendItems, function (t, e) {
                  ...
                  C + S > m.height && (w += k + i.padding, x.push(k), k = 0, C = 0), k = Math.max(k, n), C += S, p[e] = {
                    left: 0,
                    top: 0,
                    width: n,
                    height: u
            ...
            if (e.display) {
              ...
              a.each(t.legendItems, function (n, l) {
                ...
                x ? g + m >= s && (v = u.y += w, u.line++, g = u.x = t.left + (s - c[u.line]) / 2) : v + w > t.bottom && (g = u.x = g + t.columnWidths[u.line] + i.padding, v = u.y = t.top + i.padding, u.line++),
                    ...
                    if (!(isNaN(y) || y <= 0)) {
                      ...
                      if (d.setLineDash && d.setLineDash(h(n.lineDash, r.borderDash)), e.labels && e.labels.usePointStyle) {
                        var l = p * Math.SQRT2 / 2,
                          ...
                          u = t + c,
                          f = i + c;
                        a.canvas.drawPoint(d, n.pointStyle, l, u, f)
                  ...
                  }(g, v, n, f), x ? u.x += m + i.padding : u.y += w
              })
            }
          },
          handleEvent: function (t) {
          ...
          draw: function () {
            ...
            if (o.display) {
              var s, l, c, u = i(o.fontSize, r.defaultFontSize),
                ...
                f = a.fontString(u, d, h),
                p = a.options.toLineHeight(o.lineHeight, u),
                m = p / 2 + o.padding,
                g = 0,
                v = t.top,
                y = t.left,
                b = t.bottom,
                x = t.right;
              e.fillStyle = i(o.fontColor, r.defaultFontColor), e.font = f, t.isHorizontal() ? (l = y + (x - y) / 2, c = v + m, s = x - y) : (l = "left" === o.position ? y + m : x - m, c = v + (b - v) / 2, s = b - v, g = Math.PI * ("left" === o.position ? -.5 : .5)), e.save(), e.translate(l, c), e.rotate(g), e.textAlign = "center", e.textBaseline = "middle";
              var w = o.text;
              if (a.isArray(w))
            ...
            buildTicks: function () {
              var t = this,
                ...
                a = t.ticks = function (t, e) {
                  ...
                  var c = 1;
                  i < 1 && (c = Math.pow(10, i.toString().length - 2), r = Math.round(r * c) / c, s = Math.round(s * c) / c), o.push(void 0 !== t.min ? t.min : r);
                  for (var u = 1; u < l; ++u) o.push(Math.round((r + u * i) * c) / c);
          ...
          var f = t.LinearScaleBase.extend({
            ...
            fit: function () {
              ...
              this.options.pointLabels.display ? function (t) {
                ...
                var h, f, p, m = r(t);
                for (e = 0; e < m; e++) {
                  n = t.getPointPosition(e, c), h = t.ctx, f = a.size, p = t.pointLabels[e] || "", i = o.isArray(p) ? {
              ...
              if (i.display) {
                ...
                o.each(t.ticks, function (i, s) {
                  if (s > 0 || a.reverse) {
                    ...
                    if (n.display && 0 !== s && function (t, e, i, n) {
                        ...
                        if (a.strokeStyle = o.valueAtIndexOrDefault(e.color, n - 1), a.lineWidth = o.valueAtIndexOrDefault(e.lineWidth, n - 1), t.options.gridLines.circular) a.beginPath(), a.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI), a.closePath(), a.stroke();
                          ...
                          a.moveTo(l.x, l.y);
                          for (var c = 1; c < s; c++) l = t.getPointPosition(c, i), a.lineTo(l.x, l.y);
                          a.closePath(), a.stroke()
                        }
                      }(t, n, c, s), a.display) {
                      var u = l(a.fontColor, e.defaultFontColor);
                      if (h.font = v, h.save(), h.translate(t.xCenter, t.yCenter), h.rotate(f), a.showLabelBackdrop) {
                        var d = h.measureText(i).width;
                        h.fillStyle = a.backdropColor, h.fillRect(-d / 2 - a.backdropPaddingX, -c - p / 2 - a.backdropPaddingY, d + 2 * a.backdropPaddingX, p + 2 * a.backdropPaddingY)
                      }
                      h.textAlign = "center", h.textBaseline = "middle", h.fillStyle = u, h.fillText(i, 0, -c), h.restore()
                    }
                  }
                  ...
                  for (var p = r(t) - 1; p >= 0; p--) {
                    ...
                    if (l.display) {
                      var g = t.getPointPosition(p, h + 5),
                        v = o.valueAtIndexOrDefault(l.fontColor, p, e.defaultFontColor);
                      i.font = f.font, i.fillStyle = v;
                      var y = t.getIndexAngle(p),
                        b = o.toDegrees(y);
                      i.textAlign = c(b), d(b, t._pointLabelSizes[p], g), u(i, t.pointLabels[p] || "", g, f.size)
                    }
                  }
                }(t)
              }
      ...
      58: [function (t, e, i) {
        ...
        function g(t, e, i, o) {
          var r, u = o.time,
            d = u.unit || function (t, e, i, n) {
              ...
              for (o = c.indexOf(t); o < u - 1; ++o)
                if (r = (a = l[c[o]]).steps ? a.steps[a.steps.length - 1] : s, a.common && Math.ceil((i - e) / (r * a.size)) <= n) return c[o];
              return c[u - 1]
            }(u.minUnit, t, e, i),
            h = m(d),
            f = a.valueOrDefault(u.stepSize, u.unitStepSize),
          ...
          for (f || (f = function (t, e, i, n) {
              ...
              for (o = 0, a = d.length; o < a && (r = d[o], !(Math.ceil(s / (u * r)) <= n)); ++o);
              return r
            }(t, e, d, i)), p && (y = y.isoWeekday(p), b = b.isoWeekday(p)), y = y.startOf(p ? "day" : d), (b = b.startOf(p ? "day" : d)) < e && b.add(1, d), r = n(y), g && h && !p && !u.round && (r.startOf(h), r.add(~~((y - r) / (v.size * f)) * f, d)); r < b; r.add(f, d)) x.push(+r);
          return x.push(+r), x
        }
        e.exports = function (t) {
          var e = t.Scale.extend({
            ...
            determineDataLimits: function () {
              var t, e, i, o, l, c, h = this,
                ...
                x = [],
                w = [];
              for (t = 0, i = f.data.labels.length; t < i; ++t) w.push(p(f.data.labels[t], h));
              for (t = 0, i = (f.data.datasets || []).length; t < i; ++t)
                if (f.isDatasetVisible(t))
                  if (l = f.data.datasets[t].data, a.isObject(l[0]))
                    for (x[t] = [], e = 0, o = l.length; e < o; ++e) c = p(l[e], h), b.push(c), x[t][e] = c;
                  else b.push.apply(b, w), x[t] = w.slice(0);
              else x[t] = [];
              w.length && (w = d(w).sort(u), v = Math.min(v, w[0]), y = Math.max(y, w[w.length - 1])), b.length && (b = d(b).sort(u), v = Math.min(v, b[0]), y = Math.max(y, b[b.length - 1])), v = p(m.min, h) || v, y = p(m.max, h) || y, v = v === s ? +n().startOf(g) : v, y = y === r ? +n().endOf(g) + 1 : y, h.min = Math.min(v, y), h.max = Math.max(v + 1, y), h._horizontal = h.isHorizontal(), h._table = [], h._timestamps = {
                data: b,
                datasets: x,
                labels: w
              }
            ...
            buildTicks: function () {
              ...
              for ("ticks" === s.bounds && d.length && (a = d[0], r = d[d.length - 1]), a = p(u.min, o) || a, r = p(u.max, o) || r, t = 0, e = d.length; t < e; ++t)(i = d[t]) >= a && i <= r && v.push(i);
              return o.min = a, o.max = r, o._unit = u.unit || function (t, e, i, o) {
                  var a, r, s = n.duration(n(o).diff(n(i)));
                  for (a = c.length - 1; a >= c.indexOf(e); a--)
                    if (r = c[a], l[r].common && s.as(r) >= t.length) return r;
                  return c[e ? c.indexOf(e) : 0]
                }(v, u.minUnit, o.min, o.max), o._majorUnit = m(o._unit), o._table = function (t, e, i, n) {
                  ...
                  var a, r, s = 0,
                    l = 0;
                  return o.offset && e.length && (o.time.min || (a = e.length > 1 ? e[1] : n, r = e[0], s = (h(t, "time", a, "pos") - h(t, "time", r, "pos")) / 2), o.time.max || (a = e[e.length - 1], r = e.length > 1 ? e[e.length - 2] : i, l = (h(t, "time", a, "pos") - h(t, "time", r, "pos")) / 2)), {
                    left: s,
                    right: l
                  }
                }(o._table, v, a, r, s), o._labelFormat = function (t, e) {
            ...
            getLabelForIndex: function (t, e) {
              ...
              return a.isObject(r) && (o = this.getRightValue(r)), n.tooltipFormat ? f(o, n).format(n.tooltipFormat) : "string" == typeof o ? o : f(o, n).format(this._labelFormat)
            },
  ...
  function (t) {
    t(document).ready(function () {
      ...
      if (t(e).each(function (e, n) {
          ...
          i(o), n.validity.badInput && a.addClass("active")
          ...
          o && a && r && i.siblings("label, i").removeClass("active"), n(i)
        ...
        var a;
        a = window.attachEvent ? function (t, e, i) {
          ...
          a(t, "change", e), a(t, "cut", i), a(t, "paste", i), a(t, "drop", i), a(t, "keydown", i), e()
        })
      }
      ...
      t(document).on("click.card", ".card", function (e) {
        ...
        if (i.find(".card-reveal").length) {
          var n = t(e.target),
            ...
            a = n.is(".card-reveal .card-title i"),
            r = n.is(".card .activator"),
            s = n.is(".card .activator i");
          o || a ? i.find(".card-reveal").velocity({
            translateY: 0
          }, {
            duration: 225,
            queue: !1,
      ...
      return function () {
        ...
        function u(i) {
          ...
          if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), ! function (t, e) {
            ...
            return i.iconClass && u.addClass(a.toastClass).addClass(r), i.title && (f.append(i.title).addClass(a.titleClass), u.append(f)), i.message && (p.append(i.message).addClass(a.messageClass), u.append(p)), a.closeButton && (g.addClass("toast-close-button").attr("role", "button"), u.prepend(g)), a.progressBar && (m.addClass("toast-progress"), u.prepend(m)), a.newestOnTop ? e.prepend(u) : e.append(u), u.hide(), u[a.showMethod]({
...
$(".smooth-scroll").on("click", "a", function () {
    ...
    if ("undefined" !== (void 0 === t ? "undefined" : _typeof(t)) && 0 == t.indexOf("#")) {
      var e = $(this).attr("data-offset") ? $(this).attr("data-offset") : 0,
        i = $(this).closest("ul").attr("data-allow-hashes");
      return $("body,html").animate({
        scrollTop: $(t).offset().top - e
      }, SMOOTH_SCROLL_DURATION), "undefined" !== (void 0 === i ? "undefined" : _typeof(i)) && !1 !== i && history.replaceState(null, null, t), !1
    }
  }),
  function (t) {
    t.fn.scrollTo = function (e) {
      ...
      this.each(function () {
        ...
        function l(e) {
          "focus" === e && (a = !0), s(), r.addClass("active"), n.addClass("active"), !0 === o.constrain_width ? r.css("width", n.outerWidth()) : r.css("white-space", "nowrap");
          var i = window.innerHeight,
            l = n.innerHeight(),
            c = n.offset().left,
          ...
          var m = 0,
            g = n.parent();
          if (!g.is("body") && g[0].scrollHeight > g[0].clientHeight && (m = g[0].scrollTop), c + r.innerWidth() > t(window).width() ? d = "right" : c - r.innerWidth() + n.innerWidth() < 0 && (d = "left"), u + r.innerHeight() > i)
            if (u + l - r.innerHeight() < 0) {
              var v = i - u - p;
              r.css("max-height", v)
            } else p || (p += l), p -= r.innerHeight();
          if ("left" === d) h = o.gutter, f = n.position().left + h;
          else if ("right" === d) {
            f = n.position().left + n.outerWidth() - r.outerWidth() + (h = -o.gutter)
          }
          r.css({
            position: "absolute",
...
dropdownSelectors.on({
  ...
  function (t) {
    ...
    var e = function (e) {
      ...
      i = function (t) {
        ...
        var e = void 0,
          i = void 0;
        !0 === $this.hasClass("horizontal") ? i = 40 : e = 40, $this.removeClass("active");
  ...
  function (t, e, i, n) {
    ...
    var E = "ontouchstart" in t,
      O = A(t, "PointerEvent") !== n,
      L = E && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
      R = 25,
      F = 1,
      W = 2,
      V = 4,
    ...
    function G(t, e, i) {
      var o = i.pointers.length,
        ...
        r = e & F && o - a == 0,
        s = e & (V | z) && o - a == 0;
      i.isFirst = !!r, i.isFinal = !!s, r && (t.session = {}), i.eventType = e,
        function (t, e) {
          var i = t.session,
            o = e.pointers,
            a = o.length;
          i.firstInput || (i.firstInput = K(e));
          a > 1 && !i.firstMultiple ? i.firstMultiple = K(e) : 1 === a && (i.firstMultiple = !1);
          var r = i.firstInput,
            s = i.firstMultiple,
            l = s ? s.center : r.center,
            d = e.center = J(o);
          e.timeStamp = u(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = nt(l, d), e.distance = it(l, d),
            function (t, e) {
              var i = e.center,
                n = t.offsetDelta || {},
                o = t.prevDelta || {},
                a = t.prevInput || {};
              e.eventType !== F && a.eventType !== V || (o = t.prevDelta = {
                x: a.deltaX || 0,
                y: a.deltaY || 0
              }, n = t.offsetDelta = {
                x: i.x,
          ...
          e.overallVelocityX = h.x, e.overallVelocityY = h.y, e.overallVelocity = c(h.x) > c(h.y) ? h.x : h.y, e.scale = s ? (f = s.pointers, p = o, it(p[0], p[1], Q) / it(f[0], f[1], Q)) : 1, e.rotation = s ? function (t, e) {
            ...
            function (t, e) {
              ...
              if (e.eventType != z && (l > R || s.velocity === n)) {
          ...
          var f, p;
          var m = t.element;
          C(e.srcEvent.target, m) && (m = e.srcEvent.target);
          e.target = m
    ...
    function et(t, e) {
      return t === e ? N : c(t) >= c(e) ? t < 0 ? H : B : e < 0 ? j : Y
    }
    ...
    Z.prototype = {
      handler: function () {},
      init: function () {
        this.evEl && w(this.element, this.evEl, this.domHandler), this.evTarget && w(this.target, this.evTarget, this.domHandler), this.evWin && w(_(this.element), this.evWin, this.domHandler)
      },
      destroy: function () {
        this.evEl && k(this.element, this.evEl, this.domHandler), this.evTarget && k(this.target, this.evTarget, this.domHandler), this.evWin && k(_(this.element), this.evWin, this.domHandler)
      }
    };
    var ot = {
        mousedown: F,
    ...
    v(st, Z, {
      handler: function (t) {
        var e = ot[t.type];
        e & F && 0 === t.button && (this.pressed = !0), e & W && 1 !== t.which && (e = V), this.pressed && (e & V && (this.pressed = !1), this.callback(this.manager, e, {
          pointers: [t],
          changedPointers: [t],
          pointerType: "mouse",
          srcEvent: t
    ...
    t.MSPointerEvent && !t.PointerEvent && (ut = "MSPointerDown", dt = "MSPointerMove MSPointerUp MSPointerCancel"), v(ht, Z, {
      handler: function (t) {
        ...
        o & F && (0 === t.button || r) ? s < 0 && (e.push(t), s = e.length - 1) : o & (V | z) && (i = !0), s < 0 || (e[s] = t, this.callback(this.manager, o, {
          pointers: e,
          changedPointers: [t],
          pointerType: a,
          srcEvent: t
    ...
    function gt() {
      this.evTarget = pt, this.evWin = mt, this.started = !1, Z.apply(this, arguments)
    }
    v(gt, Z, {
      handler: function (t) {
        var e = ft[t.type];
        if (e === F && (this.started = !0), this.started) {
          var i = function (t, e) {
            ...
            e & (V | z) && (i = P(i.concat(n), "identifier", !0));
            return [i, n]
          }.call(this, t, e);
          e & (V | z) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, e, {
            pointers: i[0],
            changedPointers: i[1],
            pointerType: "touch",
            srcEvent: t
      ...
      handler: function (t) {
        var e = vt[t.type],
          i = function (t, e) {
            ...
            o = 0;
            for (; o < r.length;) n[r[o].identifier] && s.push(r[o]), e & (V | z) && delete n[r[o].identifier], o++;
            if (!s.length) return;
    ...
    v(kt, Z, {
      handler: function (t, e, i) {
        ...
        if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
          if (n)(function (t, e) {
            t & F ? (this.primaryTouch = e.changedPointers[0].identifier, Ct.call(this, e)) : t & (V | z) && Ct.call(this, e)
          }).call(this, e, i);
    ...
    Et.prototype = {
      set: function (t) {
        "compute" == t && (t = this.compute()), Tt && this.manager.element.style && _t[t] && (this.manager.element.style[St] = t), this.actions = t.toLowerCase().trim()
      },
      update: function () {
      ...
      preventDefaults: function (t) {
        ...
        if (this.manager.session.prevented) e.preventDefault();
          ...
          if (!r || !a) return o || a && i & $ || r && i & X ? this.preventSrc(e) : void 0
        }
      },
    ...
    function zt(t) {
      this.options = o({}, this.defaults, t || {}), this.id = D++, this.manager = null, this.options.enable = x(this.options.enable, !0), this.state = Ot, this.simultaneous = {}, this.requireFail = []
    }

    function Nt(t) {
      return t & Vt ? "cancel" : t & Ft ? "end" : t & Rt ? "move" : t & Lt ? "start" : ""
    }

    function Ht(t) {
      return t == Y ? "down" : t == j ? "up" : t == H ? "left" : t == B ? "right" : ""
    }
    ...
    function Zt(t, e) {
      return (e = e || {}).recognizers = x(e.recognizers, Zt.defaults.preset), new Gt(t, e)
    }
    zt.prototype = {
      defaults: {},
      set: function (t) {
      ...
      dropRecognizeWith: function (t) {
        return h(t, "dropRecognizeWith", this) ? this : (t = Bt(t, this), delete this.simultaneous[t.id], this)
      },
      requireFailure: function (t) {
        if (h(t, "requireFailure", this)) return this;
        var e = this.requireFail;
        return -1 === M(e, t = Bt(t, this)) && (e.push(t), t.requireFailure(this)), this
      },
      ...
      emit: function (t) {
        ...
        i < Ft && n(e.options.event + Nt(i)), n(e.options.event), t.additionalEvent && n(t.additionalEvent), i >= Ft && n(e.options.event + Nt(i))
      },
      tryEmit: function (t) {
      ...
      recognize: function (t) {
        ...
        this.state & (Wt | Vt | 32) && (this.state = Ot), this.state = this.process(e), this.state & (Lt | Rt | Ft | Vt) && this.tryEmit(e)
      },
      process: function (t) {},
      ...
      process: function (t) {
        var e = this.state,
          ...
          n = e & (Lt | Rt),
          o = this.attrTest(t);
        return n && (i & z || !o) ? e | Vt : n || o ? i & V ? e | Ft : e & Lt ? e | Rt : Lt : 32
      }
    }), v(Yt, jt, {
      defaults: {
        event: "pan",
      ...
      getTouchAction: function () {
        var t = this.options.direction,
          e = [];
        return t & $ && e.push(Dt), t & X && e.push(At), e
      },
      directionTest: function (t) {
        var e = this.options,
          ...
          a = t.deltaX,
          r = t.deltaY;
        return o & e.direction || (e.direction & $ ? (o = 0 === a ? N : a < 0 ? H : B, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? N : r < 0 ? j : Y, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
      },
      attrTest: function (t) {
      ...
      process: function (t) {
        ...
        if (this._input = t, !n || !i || t.eventType & (V | z) && !o) this.reset();
        else if (t.eventType & F) this.reset(), this._timer = d(function () {
          this.state = Wt, this.tryEmit()
        }, e.time, this);
        else if (t.eventType & V) return Wt;
        return 32
      },
      reset: function () {
      ...
      emit: function (t) {
        this.state === Wt && (t && t.eventType & V ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = u(), this.manager.emit(this.options.event, this._input)))
      }
    }), v(qt, jt, {
      defaults: {
        event: "rotate",
      ...
      attrTest: function (t) {
        ...
        return i & ($ | X) ? e = t.overallVelocity : i & $ ? e = t.overallVelocityX : i & X && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && c(e) > this.options.velocity && t.eventType & V
      },
      emit: function (t) {
    ...
    function Gt(t, e) {
      var i;
      this.options = o({}, Zt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new((i = this).options.inputClass || (O ? ht : L ? bt : E ? kt : st))(i, G), this.touchAction = new Et(this, this.options.touchAction), Kt(this, !0), f(this.options.recognizers, function (t) {
    ...
    function Kt(t, e) {
      var i, n = t.element;
      n.style && (f(t.options.cssProps, function (o, a) {
      ...
      recognize: function (t) {
        ...
        if (!e.stopped) {
          ...
          var n = this.recognizers,
            o = e.curRecognizer;
          (!o || o && o.state & Wt) && (o = e.curRecognizer = null);
  ...
  var e = 240,
    ...
    c = function () {
      function c(u, d) {
        ...
        d = t.extend(p, d), this.options = d;
        var m = u;
        this.menu_id = t("#" + m.attr("data-activates"));
        var g = t("#" + this.menu_id.attr("id") + "> .sidenav-bg");
        d.MENU_WIDTH !== e && (this.menu_id.css("width", d.MENU_WIDTH), g.css("width", d.MENU_WIDTH));
        var v = t('<div class="drag-target"></div>');
        t("body").append(v), "left" === d.edge ? (this.menu_id.css("transform", "translateX(-100%)"), v.css({
          left: 0
        })) : (this.menu_id.addClass("right-aligned").css("transform", "translateX(100%)"), v.css({
          right: 0
        })), this.menu_id.hasClass("fixed") && (window.innerWidth > i && this.menu_id.css("transform", "translateX(0)"), t(window).resize(function () {
          window.innerWidth > i ? t("#sidenav-overlay").length ? h.removeMenu(!0) : h.menu_id.css("transform", "translateX(0%)") : !1 === f && ("left" === d.edge ? h.menu_id.css("transform", "translateX(-100%)") : h.menu_id.css("transform", "translateX(100%)"))
        })), !0 === this.options.closeOnClick && this.menu_id.on("click", "a:not(.collapsible-header)", function () {
          h.removeMenu()
        }), m.click(function (e) {
          if (e.preventDefault(), !0 === f) f = !1, h.removeMenu();
          else {
            var i = t("body"),
              n = t('<div id="sidenav-overlay"></div>');
            i.append(n), "left" === h.options.edge ? h.menu_id.velocity({
          ...
          if ("touch" === e.gesture.pointerType) {
            var i = e.gesture.center.x,
              o = t("body"),
              a = o.innerWidth();
            if (o.css("overflow", "hidden"), o.width(a), 0 === t("#sidenav-overlay").length) {
              var r = t('<div id="sidenav-overlay"></div>');
              r.css("opacity", 0).click(function () {
                h.removeMenu()
              }), t("body").append(r)
            }
            if ("left" === d.edge && (i > d.MENU_WIDTH ? i = d.MENU_WIDTH : i < 0 && (i = 0)), "left" === d.edge) i < d.MENU_WIDTH / n ? f = !1 : i >= d.MENU_WIDTH / n && (f = !0), h.menu_id.css("transform", "translateX(" + (i - d.MENU_WIDTH) + "px)");
            else {
              i < window.innerWidth - d.MENU_WIDTH / n ? f = !0 : i >= window.innerWidth - d.MENU_WIDTH / n && (f = !1);
              var s = i - d.MENU_WIDTH / n;
              s < 0 && (s = 0), h.menu_id.css("transform", "translateX(" + s + "px)")
            }
            var l = void 0;
            "left" === d.edge ? (l = i / d.MENU_WIDTH, t("#sidenav-overlay").velocity({
              opacity: l
            }, {
              duration: 10,
              queue: !1,
              easing: "easeOutQuad"
            })) : (l = Math.abs((i - window.innerWidth) / d.MENU_WIDTH), t("#sidenav-overlay").velocity({
              opacity: l
            }, {
              duration: 10,
              queue: !1,
          ...
          if ("touch" === e.gesture.pointerType) {
            var i = e.gesture.velocityX,
              c = e.gesture.center.x,
              u = c - d.MENU_WIDTH,
              p = c - d.MENU_WIDTH / n;
            u > 0 && (u = 0), p < 0 && (p = 0), "left" === d.edge ? f && i <= o || i < a ? (0 !== u && h.menu_id.velocity({
              translateX: [0, u]
            }, {
              duration: 300,
              queue: !1,
      ...
      return _createClass(c, [{
        ...
        value: function (e) {
          ...
          t("body").css({
            ...
            easing: "easeOutCubic",
            complete: function () {
              !0 === e && (i.menu_id.removeAttr("style"), i.menu_id.css("width", i.options.MENU_WIDTH))
            }
...
function (t) {
  t.fn.collapsible = function (e) {
    ...
    return e = t.extend(i, e), this.each(function () {
      ...
      i.off("click.collapse", ".collapsible-header"), n.off("click.collapse"), e.accordion || "accordion" === o || void 0 === o ? ((n = i.find("> li > .collapsible-header")).on("click.collapse", function (e) {
        var i = t(e.target);
...
function (t) {
  ...
  t(document).on("change", e, function () {
  ...
  }), t(document).on("input mousedown touchstart", e, function (o) {
    var a = t(this),
      r = a.siblings(".thumb"),
      s = a.outerWidth();
    if (!r.length && function () {
        var i = t('<span class="thumb"><span class="value"></span></span>');
        t(e).after(i)
      }(), r.find(".value").html(a.val()), i = !0, a.addClass("active"), r.hasClass("active") || r.velocity({
        height: "30px",
        width: "30px",
        top: "-20px",
        marginLeft: "-15px"
      ...
      (n = l ? o.originalEvent.touches[0].pageX - t(this).offset().left : o.pageX - t(this).offset().left) < 0 ? n = 0 : n > s && (n = s), r.addClass("active").css("left", n)
    }
    r.find(".value").html(a.val())
  }), t(document).on("mouseup touchend", ".range-field", function () {
    i = !1, t(this).removeClass("active")
  }), t(document).on("mousemove touchmove", ".range-field", function (n) {
    ...
    if (i) {
      o.hasClass("active") || o.velocity({
        ...
        duration: 300,
        easing: "easeOutExpo"
      }), a = void 0 === n.pageX || null === n.pageX ? n.originalEvent.touches[0].pageX - t(this).offset().left : n.pageX - t(this).offset().left;
      var r = t(this).outerWidth();
      a < 0 ? a = 0 : a > r && (a = r), o.addClass("active").css("left", a), o.find(".value").html(o.siblings(e).val())
    }
...
function (t) {
  t(document).on("change", '.file-field input[type="file"]', function (e) {
    for (var i = t(e.target), n = i.closest(".file-field").find("input.file-path"), o = i[0].files, a = [], r = 0; r < o.length; r++) {
      var s = o[r].name;
      a.push(s)
    }
...
function (t) {
  t.fn.material_select = function (e) {
    function i(t, e, i) {
      var n = t.indexOf(e),
        o = -1 === n;
      return o ? t.push(e) : t.splice(n, 1), i.siblings("ul.dropdown-content").find("li:not(.optgroup)").eq(e).toggleClass("active"), i.find("option").eq(e).prop("selected", o),
        function (t, e) {
    ...
    t(this).each(function () {
      ...
      if (!n.hasClass("browser-default")) {
        var o = Boolean(n.attr("multiple")),
          a = n.data("select-id");
        if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()), "destroy" !== e) {
          var r, s = (r = (new Date).getTime(), "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (t) {
            var e = (r + 16 * Math.random()) % 16 | 0;
            return r = Math.floor(r / 16), ("x" == t ? e : 3 & e | 8).toString(16)
          }));
          n.data("select-id", s);
          var l = t('<div class="select-wrapper"></div>');
          l.addClass(n.attr("class"));
          var c, u, d = t('<ul id="select-options-' + s + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>'),
            h = n.children("option, optgroup"),
            f = [],
            p = !1,
            ...
            g = function () {
              ...
              e.find("li").find("span.filtrable").each(function () {
                "string" == typeof this.outerHTML && (-1 === this.textContent.toLowerCase().indexOf(i.toLowerCase()) ? (t(this).hide(), t(this).parent().hide()) : (t(this).show(), t(this).parent().show()))
              })
            },
            v = Boolean(n.attr("searchable"));
          v && (c = n.attr("searchable"), u = t('<span class="search-wrap"><div class="md-form"><input type="text" class="search form-control" placeholder="' + c + '"></div></span>'), d.append(u), u.find(".search").keyup(g));
          var y = function (e, i, n) {
            ...
            if (r) {
              var l = "";
              return s && (l = ' class="' + s + '"'), "multiple" === n ? d.append(t('<li class="' + o + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable"><input class="form-check-input" type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : d.append(t('<li class="' + o + a + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable">' + i.html() + "</span></li>")), !0
            }
            "multiple" === n ? d.append(t('<li class="' + o + '"><span class="filtrable"><input class="form-check-input" type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : d.append(t('<li class="' + o + a + '"><span class="filtrable">' + i.html() + "</span></li>"))
          };
          h.length && h.each(function () {
            if (t(this).is("option")) o ? y(0, t(this), "multiple") : y(0, t(this));
            ...
            t(this).click(function (r) {
              if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                ...
                o ? (t('input[type="checkbox"]', this).prop("checked", function (t, e) {
                  return !e
                }), s = i(f, v ? b ? t(this).index() - t(this).prevAll(".optgroup").length - 1 : t(this).index() - 1 : b ? t(this).index() - t(this).prevAll(".optgroup").length : t(this).index(), n), C.trigger("focus")) : (d.find("li").removeClass("active"), t(this).toggleClass("active"), C.val(t(this).text())), S(d, t(this)), n.find("option").eq(a).prop("selected", s), n.trigger("change"), void 0 !== e && e()
              }
              r.stopPropagation()
            })
          }), n.wrap(l);
          var w = t('<span class="caret">&#9660;</span>');
          n.is(":disabled") && w.addClass("disabled");
          var k = m.replace(/"/g, "&quot;"),
            C = t('<input type="text" class="select-dropdown" readonly="true" ' + (n.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + s + '" value="' + k + '"/>');
          n.before(C), C.before(w), C.after(d), n.is(":disabled") || C.dropdown({
            hover: !1,
            closeOnClick: !1
          }), n.attr("tabindex") && t(C[0]).attr("tabindex", n.attr("tabindex")), n.addClass("initialized"), C.on({
            focus: function () {
            ...
            o || v || t(this).trigger("close"), d.find("li.selected").removeClass("selected")
            ...
            t(".modal-content").find(d).length && this.scrollHeight > this.offsetHeight && e.preventDefault()
          }), t(window).on({
            click: function () {
              (o || v) && (p || C.trigger("close"))
            }
          }), o && n.find("option:selected:not(:disabled)").each(function () {
            var e = t(this).index();
            i(f, e, n), d.find("li").eq(e).find(":checkbox").prop("checked", !0)
          });
          var S = function (e, i) {
              i && (e.find("li.selected").removeClass("selected"), t(i).addClass("selected"))
            },
            T = [];
            ...
            if (9 != e.which)
              if (40 != e.which || d.is(":visible")) {
                if (13 != e.which || d.is(":visible")) {
                  ...
                  if (13 == e.which) {
                    var r = d.find("li.selected:not(.disabled)")[0];
                    r && (t(r).trigger("click"), o || C.trigger("close"))
                  }
                  40 == e.which && (a = d.find("li.selected").length ? d.find("li.selected").next("li:not(.disabled)")[0] : d.find("li:not(.disabled)")[0], S(d, a)), 27 == e.which && C.trigger("close"), 38 == e.which && (a = d.find("li.selected").prev("li:not(.disabled)")[0]) && S(d, a), setTimeout(function () {
                    T = []
                  }, 1e3)
                }
              } else C.trigger("open");
  ...
  function (t) {
    ...
    function a(e, l, u, d) {
      ...
      var h = !1,
        ...
        p = u ? t.extend(!0, {}, u.defaults, d) : d || {},
        m = t.extend({}, a.klasses(), p.klass),
        g = t(e),
        v = function () {
          return this.start()
        },
        y = v.prototype = {
          ...
          $node: g,
          start: function () {
            return f && f.start ? y : (f.methods = {}, f.start = !0, f.open = !1, f.type = e.type, e.autofocus = e == c(), e.readOnly = !p.editable, e.id = e.id || f.id, "text" != e.type && (e.type = "text"), y.component = new u(y, p), y.$root = t('<div class="' + m.picker + '" id="' + e.id + '_root" />'), s(y.$root[0], "hidden", !0), y.$holder = t(b()).appendTo(y.$root), x(), p.formatSubmit && function () {
              var i;
              !0 === p.hiddenName ? (i = e.name, e.name = "") : i = (i = ["string" == typeof p.hiddenPrefix ? p.hiddenPrefix : "", "string" == typeof p.hiddenSuffix ? p.hiddenSuffix : "_submit"])[0] + e.name + i[1];
              y._hidden = t('<input type=hidden name="' + i + '"' + (g.data("value") || e.value ? ' value="' + y.get("select", p.formatSubmit) + '"' : "") + ">")[0], g.on("change." + f.id, function () {
                y._hidden.value = e.value ? y.get("select", p.formatSubmit) : ""
              })
            }(), function () {
              g.data(l, y).addClass(m.input).val(g.data("value") ? y.get("select", p.format) : e.value), p.editable || g.on("focus." + f.id + " click." + f.id, function (t) {
            ...
            }(), p.containerHidden ? t(p.containerHidden).append(y._hidden) : g.after(y._hidden), p.container ? t(p.container).append(y.$root) : g.after(y.$root), y.on({
          ...
          render: function (e) {
            return e ? (y.$holder = t(b()), x(), y.$root.html(y.$holder)) : y.$root.find("." + m.box).html(y.component.nodes(f.open)), y.trigger("render")
          },
          stop: function () {
            return f.start ? (y.close(), y._hidden && y._hidden.parentNode.removeChild(y._hidden), y.$root.remove(), g.removeClass(m.input).removeData(l), setTimeout(function () {
              g.off("." + f.id)
            }, 0), e.type = f.type, e.readOnly = !1, y.trigger("stop"), f.methods = {}, f.start = !1, y) : y
          },
          open: function (l) {
            return f.open ? y : (g.addClass(m.active), s(e, "expanded", !0), setTimeout(function () {
              y.$root.addClass(m.opened), s(y.$root[0], "hidden", !1)
            }, 0), !1 !== l && (f.open = !0, h && n.css("overflow", "hidden").css("padding-right", "+=" + r()), h && o ? y.$holder.find("." + m.frame).one("transitionend", function () {
              y.$holder[0].focus()
            }) : y.$holder[0].focus(), i.on("click." + f.id + " focusin." + f.id, function (t) {
              var i = t.target;
              ...
              var i = e.keyCode,
                n = y.component.key[i],
                o = e.target;
              27 == i ? y.close(!0) : o != y.$holder[0] || !n && 13 != i ? t.contains(y.$root[0], o) && 13 == i && (e.preventDefault(), o.click()) : (e.preventDefault(), n ? a._.trigger(y.component.key.go, y, [a._.trigger(n)]) : y.$root.find("." + m.highlighted).hasClass(m.disabled) || (y.set("select", y.component.item.highlight), p.closeOnSelect && y.close(!0)))
            })), y.trigger("open"))
          },
          close: function (t) {
            return t && (p.editable ? e.focus() : (y.$holder.off("focus.toOpen").focus(), setTimeout(function () {
            ...
            }, 0), f.open ? (f.open = !1, h && n.css("overflow", "").css("padding-right", "-=" + r()), i.off("." + f.id), y.trigger("close")) : y
          },
          clear: function (t) {
          ...
          set: function (e, i, n) {
            ...
            if (n = r && t.isPlainObject(i) ? i : n || {}, e) {
              for (o in r || (s[e] = i), s) a = s[o], o in y.component.item && (void 0 === a && (a = null), y.component.set(o, a, n)), "select" != o && "clear" != o || g.val("clear" == o ? "" : y.get(o, p.format)).trigger("change");
              y.render()
            }
          ...
          on: function (e, i, n) {
            var o, a, r = t.isPlainObject(e),
              s = r ? e : {};
            if (e)
              for (o in r || (s[e] = i), s) a = s[o], n && (o = "_" + o), f.methods[o] = f.methods[o] || [], f.methods[o].push(a);
            return y
          },
          off: function () {
            var t, e, i = arguments;
      ...
      function b() {
        return a._.node("div", a._.node("div", a._.node("div", a._.node("div", y.component.nodes(f.open), m.box), m.wrap), m.frame), m.holder, 'tabindex="-1"')
      }
      ...
      function x() {
        y.$holder.on({
          ...
          var e = t(this),
            ...
            o = c();
          o = o && (o.type || o.href), (n || o && !t.contains(y.$root[0], o)) && y.$holder[0].focus(), !n && i.nav ? y.set("highlight", y.component.item.highlight, {
            nav: i.nav
          }) : !n && "pick" in i ? (y.set("select", i.pick), p.closeOnSelect && y.close(!0)) : i.clear ? (y.clear(), p.closeOnClear && y.close(!0)) : i.close && y.close(!0)
        })
      }
      ...
      function k(t) {
        ...
        (32 == e || i || !f.open && y.component.key[e]) && (t.preventDefault(), t.stopPropagation(), i ? y.clear().close() : y.open())
      }
      return new v
    }
  ...
  function (t) {
    ...
    o.prototype.set = function (t, e, i) {
      ...
      if ((!o || !o.nav && !o.defaultValue) && (!h && c.disabled(i) || h && c.disabled(i) && (m || a || r) || !h && (i.pick <= f.pick || i.pick >= p.pick)))
        for (h && !m && (!r && d > 0 || !a && d < 0) && (d *= -1); c.disabled(i) && (Math.abs(d) > 1 && (i.month < u.month || i.month > u.month) && (i = u, d = d > 0 ? 1 : -1), i.pick <= f.pick ? (s = !0, d = 1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : -1)])) : i.pick >= p.pick && (l = !0, d = -1, i = c.create([p.year, p.month, p.date + (i.pick === p.pick ? 0 : 1)])), !s || !l);) i = c.create([i.year, i.month, i.date + d]);
      return i
      ...
      var e, i, o = this,
        ...
        h = r.min,
        f = r.max,
        p = (e = (a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(0), i = a.weekdaysFull.slice(0), a.firstDay && (e.push(e.shift()), i.push(i.shift())), n.node("thead", n.node("tr", n.group({
          min: 0,
          max: 6,
          i: 1,
          node: "th",
        ...
        m = function (t) {
          return n.node("div", " ", a.klass["nav" + (t ? "Next" : "Prev")] + (t && u.year >= f.year && u.month >= f.month || !t && u.year <= h.year && u.month <= h.month ? " " + a.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + n.ariaAttr({
            role: "button",
      ...
      return n.node("div", (a.selectYears ? v() + g() : g() + v()) + m() + m(1), a.klass.header) + n.node("table", p + n.node("tbody", n.group({
        min: 0,
        max: 5,
        i: 1,
        node: "tr",
        item: function (t) {
          ...
          return [n.group({
            ...
            item: function (t) {
              ...
              return [n.node("div", t.date, (e = [a.klass.day], e.push(u.month == t.month ? a.klass.infocus : a.klass.outfocus), s.pick == t.pick && e.push(a.klass.now), i && e.push(a.klass.selected), r && e.push(a.klass.highlighted), p && e.push(a.klass.disabled), e.join(" ")), "data-pick=" + t.pick + " " + n.ariaAttr({
                role: "gridcell",
                label: m,
  ...
  function () {
    ...
    function S(t, e) {
      var i, o, r = n(C),
        ...
        f = r.find(".clockpicker-hours"),
        S = r.find(".clockpicker-minutes"),
      ...
      var E, O, L, R, F = n('<div class="clockpicker-tick"></div>');
      if (e.twelvehour)
        for (E = 0; E < 12; E += e.hourstep) O = F.clone(), L = E / 6 * Math.PI, R = y, O.css("font-size", "140%"), O.css({
          left: v + Math.sin(L) * R - x,
          top: v - Math.cos(L) * R - x
        }), O.html(0 === E ? 12 : E), f.append(O), O.on(u, z);
      else
        for (E = 0; E < 24; E += e.hourstep) {
          O = F.clone(), L = E / 6 * Math.PI;
          var W = E > 0 && E < 13;
          R = W ? b : y, O.css({
            left: v + Math.sin(L) * R - x,
            top: v - Math.cos(L) * R - x
          }), W && O.css("font-size", "120%"), O.html(0 === E ? "00" : E), f.append(O), O.on(u, z)
        }
      var V = Math.max(e.minutestep, 5);
      for (E = 0; E < 60; E += V)
        for (E = 0; E < 60; E += 5) O = F.clone(), L = E / 30 * Math.PI, O.css({
          left: v + Math.sin(L) * y - x,
          top: v - Math.cos(L) * y - x
        }), O.css("font-size", "140%"), O.html(m(E)), S.append(O), O.on(u, z);
      ...
      function z(t, i) {
        var n = l.offset(),
          ...
          f = (o ? t.originalEvent.touches[0] : t).pageY - c,
          p = Math.sqrt(u * u + f * f),
          m = !1;
        if (!i || !(p < y - x || p > y + x)) {
          t.preventDefault();
          ...
          s && l.append(D.canvas), D.setHand(u, f, !i, !0), a.off(d).on(d, function (t) {
            ...
            (i || m) && o === u && s === f && D.setHand(o, s), "hours" === D.currentView ? D.toggleView("minutes", k / 2) : e.autoclose && (D.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
              D.done()
            }, k / 2)), l.prepend(N), clearTimeout(g), D.popover.removeClass("clockpicker-moving"), a.off(d)
          })
        }
      }
      if (l.on(u, function (t) {
        ...
        var N = r.find(".clockpicker-canvas"),
          H = p("svg");
        H.setAttribute("class", "clockpicker-svg"), H.setAttribute("width", w), H.setAttribute("height", w);
        var B = p("g");
        B.setAttribute("transform", "translate(" + v + "," + v + ")");
        var j = p("circle");
        ...
        var X = p("circle");
        X.setAttribute("class", "clockpicker-canvas-fg"), X.setAttribute("r", 5), B.appendChild(Y), B.appendChild($), B.appendChild(X), B.appendChild(j), H.appendChild(B), N.append(H), this.hand = Y, this.bg = $, this.fg = X, this.bearing = j, this.g = B, this.canvas = N
      }
      T(this.options.init)
    }
    ...
    S.DEFAULTS = {
    ...
    }, S.prototype.toggleView = function (t, e) {
      var i = !1;
      ...
      }, k), i && T(this.options.afterHourSelect)
    ...
    }, S.prototype.setHand = function (t, e, i, o) {
      var a, r, l = Math.atan2(t, -e),
        ...
        h = c && u < (y + b) / 2,
        p = h ? b : y;
      if (a = c ? d.hourstep / 6 * Math.PI : d.minutestep / 30 * Math.PI, d.twelvehour && (p = y), l < 0 && (l = 2 * Math.PI + l), l = (r = Math.round(l / a)) * a, c ? (r *= d.hourstep, d.twelvehour || !h != r > 0 || (r += 12), d.twelvehour && 0 === r && (r = 12), 24 === r && (r = 0)) : 60 === (r *= d.minutestep) && (r = 0), c ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : r % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== r && f && this.options.vibrate && (this.vibrateTimer || (navigator[f](10), this.vibrateTimer = setTimeout(n.proxy(function () {
      ...
      var t = this.input.prop("value"),
        e = this.hours,
        i = ":" + m(this.minutes);
      this.isHTML5 && this.options.twelvehour && (this.hours < 12 && "PM" === this.amOrPm && (e += 12), 12 === this.hours && "AM" === this.amOrPm && (e = 0)), i = m(e) + i, !this.isHTML5 && this.options.twelvehour && (i += this.amOrPm), this.input.prop("value", i), i !== t && (this.input.trigger("change"), this.isInput || this.element.trigger("change")), this.options.autoclose && this.input.trigger("blur"), T(this.options.afterDone)
      ...
      function i() {
        ...
        if (o) "function" == typeof o[t] && o[t].apply(o, e);
          ...
          var a = n.extend({}, S.DEFAULTS, i.data(), "object" == typeof t && t);
          i.data("clockpicker", new S(i, a))
        }
      }
      if (1 == this.length) {
  ...
  function (t, e) {
    ...
    return function (t, e, i, n) {
      ...
      o.extend(r, n);
      var s, l, c, u, d, h, f, p, m, g, v, y, b, x, w, k, C, S, T, M, I, P, A, D, _, E, O, L, R, F, W, V, z, N, H, B, j, Y, $, X, q, U, Q, Z, G, K, J, tt, et, it, nt, ot, at, rt, st, lt = {
          x: 0,
          y: 0
        },
        ct = {
        ...
        Rt = null,
        Ft = function () {
          Rt && (o.unbind(document, "mousemove", Ft), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")), Rt = setTimeout(function () {
            Rt = null
          }, 100)
        },
        Wt = function (t, e) {
          var i = $e(a.currItem, dt, t);
          return e && (J = i), i
        },
        Vt = function (t) {
        ...
        Nt = function (t, e, i, n) {
          return n === a.currItem.initialZoomLevel ? (i[t] = a.currItem.initialPosition[t], !0) : (i[t] = Et(t, n), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0))
        },
        Ht = function (t) {
          var e = "";
        ...
        Bt = function (t) {
          t && (q || X || et || B) && (t.preventDefault(), t.stopPropagation())
        },
        jt = function () {
        ...
        $t = 0,
        Xt = function (t) {
          Yt[t] && (Yt[t].raf && E(Yt[t].raf), $t--, delete Yt[t])
        },
        qt = function (t) {
          Yt[t] && Xt(t), Yt[t] || ($t++, Yt[t] = {})
        },
        Ut = function () {
        ...
        Qt = function (t, e, i, n, o, a, r) {
          ...
          var c = function () {
            if (Yt[t]) {
              if ((s = Tt() - l) >= n) return Xt(t), a(i), void(r && r());
              a((i - e) * o(s / n) + e), Yt[t].raf = _(c)
            }
          };
          c()
        },
        Zt = {
          ...
          setScrollOffset: function (t, e) {
            ft.x = t, F = ft.y = e, St("updateScrollOffset", ft)
          },
          ...
          init: function () {
            if (!s && !l) {
              var i;
              a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), O = t.className, s = !0, W = o.detectFeatures(), _ = W.raf, E = W.caf, P = W.transform, R = W.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                ...
                function () {
                  if (P) {
                    var e = W.perspective && !D;
                    return y = "translate" + (e ? "3d(" : "("), void(b = W.perspective ? ", 0px)" : ")")
                  }
                  P = "left", o.addClass(t, "pswp--ie"), Dt = function (t, e) {
                    e.left = t + "px"
                  }, At = function (t) {
              ...
              for (W.animationName && W.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0; i < vt.length; i++) a["init" + vt[i]]();
              e && (a.ui = new e(a, o)).init(), St("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= Ne()) && (u = 0), a.currItem = ze(u), (W.isOldIOSPhone || W.isOldAndroid) && (gt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (gt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === F && (St("initialLayout"), F = L = o.getScrollY());
              var c = "pswp--open ";
              for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += D ? "pswp--touch" : "pswp--notouch", c += W.animationName ? " pswp--css_animation" : "", c += W.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, mt = null, i = 0; 3 > i; i++) Dt((i + h) * pt.x, k[i].el.style);
              R || o.bind(a.scrollWrap, p, a), Ct("initialZoomInEnd", function () {
                a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), o.bind(document, "keydown", a), W.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", Ft), o.bind(window, "resize scroll", a), St("bindEvents")
              }), a.setContent(k[1], u), a.updateCurrItem(), St("afterInit"), gt || (x = setInterval(function () {
                $t || Y || G || g !== a.currItem.initialZoomLevel || a.updateSize()
              }, 1e3)), o.addClass(t, "pswp--visible")
            }
          },
          close: function () {
            s && (s = !1, l = !0, St("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ft), W.transform && o.unbind(a.scrollWrap, "click", a), Y && o.unbind(window, f, a), St("unbindEvents"), He(a.currItem, null, !0, a.destroy))
          },
          destroy: function () {
            St("destroy"), Re && clearTimeout(Re), t.setAttribute("aria-hidden", "true"), t.className = O, x && clearInterval(x), o.unbind(a.scrollWrap, p, a), o.unbind(window, "scroll", a), fe(), Ut(), kt = null
          },
          ...
          goTo: function (t) {
            var e = (t = wt(t)) - u;
            mt = e, u = t, a.currItem = ze(u), ht -= e, _t(pt.x * ht), Ut(), et = !1, a.updateCurrItem()
          },
          next: function () {
            a.goTo(u + 1)
          },
          ...
          updateCurrItem: function (t) {
            if (0 !== mt) {
              var e, i = Math.abs(mt);
              if (!(t && 2 > i)) {
                a.currItem = ze(u), bt = !1, St("beforeChange", mt), i >= 3 && (h += mt + (mt > 0 ? -3 : 3), i = 3);
                for (var n = 0; i > n; n++) mt > 0 ? (e = k.shift(), k[2] = e, Dt((++h + 2) * pt.x, e.el.style), a.setContent(e, u - i + n + 1 + 1)) : (e = k.pop(), k.unshift(e), Dt(--h * pt.x, e.el.style), a.setContent(e, u + i - n - 1 - 1));
                if (tt && 1 === Math.abs(mt)) {
                  var o = ze(C);
                  o.initialZoomLevel !== g && ($e(o, dt), Qe(o), At(o))
                }
          ...
          updateSize: function (e) {
            ...
            if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, jt(), pt.x = dt.x + Math.round(dt.x * r.spacing), pt.y = dt.y, _t(pt.x * ht), St("beforeResize"), void 0 !== h) {
              for (var n, s, l, c = 0; 3 > c; c++) n = k[c], Dt((c + h) * pt.x, n.el.style), l = u + c - 1, r.loop && Ne() > 2 && (l = wt(l)), (s = ze(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && ($e(s, dt), Qe(s), At(s));
              w = !1
            }
          ...
          zoomTo: function (t, e, i, n, a) {
            e && (v = g, ue.x = Math.abs(e.x) - ut.x, ue.y = Math.abs(e.y) - ut.y, Ot(ct, ut));
            var r = Wt(t, !1),
              s = {};
        ...
        Te = function (t, e) {
          var i, n, o, s, l = ut[t] + e[t],
            ...
            u = ce.x + e.x,
            d = ce.x - ne.x;
          return i = l > J.min[t] || l < J.max[t] ? r.panEndFriction : 1, l = ut[t] + e[t] * i, !r.allowPanToNext && g !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || X || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && Ne() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && Ne() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || Q || g > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (_t(s, !0), Q = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : Q || (ut.x += e.x * i)), void 0 !== s)
        },
        Me = function (t) {
          if (!("mousedown" === t.type && t.button > 0)) {
            ...
            if (!j || "mousedown" !== t.type) {
              ...
              var i = Se(t),
                n = i.length;
              Z = null, Ut(), Y && 1 !== n || (Y = nt = !0, o.bind(window, f, a), H = rt = ot = B = Q = q = $ = X = !1, it = null, St("firstTouchStart", i), Ot(ct, ut), lt.x = lt.y = 0, Ot(te, i[0]), Ot(ee, te), ne.x = pt.x * ht, oe = [{
                x: te.x,
                y: te.y
              }], z = V = Tt(), Wt(g, !0), fe(), pe()), !G && n > 1 && !et && !Q && (v = g, X = !1, G = $ = !0, lt.y = lt.x = 0, Ot(ct, ut), Ot(Gt, i[0]), Ot(Kt, i[1]), be(Gt, Kt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, K = he(Gt, Kt))
            }
          }
        },
        Ie = function (t) {
        ...
        Pe = function () {
          if (Z) {
            var t = Z.length;
            if (0 !== t)
              if (Ot(Gt, Z[0]), Jt.x = Gt.x - te.x, Jt.y = Gt.y - te.y, G && t > 1) {
                if (te.x = Gt.x, te.y = Gt.y, !Jt.x && !Jt.y && function (t, e) {
                    return t.x === e.x && t.y === e.y
                  }(Z[1], Kt)) return;
                Ot(Kt, Z[1]), X || (X = !0, St("zoomGestureStarted"));
                var e = he(Gt, Kt),
                  i = Oe(e);
                ...
                if (o > i)
                  if (r.pinchToClose && !rt && v <= a.currItem.initialZoomLevel) {
                    var l = 1 - (o - i) / (o / 1.2);
                    Mt(l), St("onPinchClose", l), ot = !0
                  } else(n = (o - i) / o) > 1 && (n = 1), i = o - n * (o / 3);
                else i > s && ((n = (i - s) / (6 * o)) > 1 && (n = 1), i = s + n * o);
                0 > n && (n = 0), be(Gt, Kt, se), lt.x += se.x - de.x, lt.y += se.y - de.y, Ot(de, se), ut.x = Et("x", i), ut.y = Et("y", i), H = i > g, g = i, Pt()
              } else {
                if (!it) return;
                if (nt && (nt = !1, Math.abs(Jt.x) >= 10 && (Jt.x -= Z[0].x - ee.x), Math.abs(Jt.y) >= 10 && (Jt.y -= Z[0].y - ee.y)), te.x = Gt.x, te.y = Gt.y, 0 === Jt.x && 0 === Jt.y) return;
                if ("v" === it && r.closeOnVerticalDrag && "fit" === r.scaleMode && g === a.currItem.initialZoomLevel) {
                  lt.y += Jt.y, ut.y += Jt.y;
                  var c = xe();
                  return B = !0, St("onVerticalDrag", c), Mt(c), void Pt()
                }(function (t, e, i) {
                  if (t - z > 50) {
                    var n = oe.length > 2 ? oe.shift() : {};
                    n.x = e, n.y = i, oe.push(n), z = t
                  }
                })(Tt(), Gt.x, Gt.y), q = !0, J = a.currItem.bounds, Te("x", Jt) || (Te("y", Jt), Lt(ut), Pt())
              }
          }
        },
        Ae = function (t) {
          ...
          1 === l && Ot(ee, s[0]), 0 !== l || it || et || (e || ("mouseup" === t.type ? e = {
            x: t.pageX,
            y: t.pageY,
            type: "mouse"
          ...
          var c = -1;
          if (0 === l && (Y = !1, o.unbind(window, f, a), fe(), G ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, q || X || et || B)
            if (Ut(), N || (N = De()), N.calculateSwipeSpeed("x"), B)
              if (xe() < r.verticalDragRange) a.close();
              else {
                var u = ut.y,
                  d = at;
                Qt("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (t) {
                  ut.y = (a.currItem.initialPosition.y - u) * t + u, Mt((1 - d) * t + d), Pt()
                }), St("onVerticalDrag", 1)
              }
          else {
            if ((Q || et) && 0 === l) {
        ...
        De = function () {
          var t, e, i = {
            ...
            panAnimLoop: function () {
              return Yt.zoomPan && (Yt.zoomPan.raf = _(i.panAnimLoop), i.now = Tt(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), Pt(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05) ? (ut.x = Math.round(ut.x), ut.y = Math.round(ut.y), Pt(), void Xt("zoomPan")) : void 0
            }
          };
          return i
        },
        ...
        Ee = function (t, e) {
          ...
          var d, h = pt.x * ht,
            f = Math.abs(h - ce.x);
          return i || h > ce.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? f / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, re === u && (i = !1), et = !0, St("mainScrollAnimStart"), Qt("mainScroll", ce.x, h, d, o.easing.cubic.out, _t, function () {
        ...
        publicMethods: {
          initGestures: function () {
            var t = function (t, e, i, n, o) {
              S = t + e, T = t + i, M = t + n, I = o ? t + o : ""
            };
            (A = W.pointerEvent) && W.touch && (W.touch = !1), A ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : W.touch ? (t("touch", "start", "move", "end", "cancel"), D = !0) : t("mouse", "down", "move", "up"), f = T + " " + M + " " + I, p = S, A && !D && (D = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = D, m[S] = Me, m[T] = Ie, m[M] = Ae, I && (m[I] = m[M]), W.touch && (p += " mousedown", f += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[T], m.mouseup = m[M]), D || (r.allowPanToNext = !1)
          }
        }
      });
      var Re, Fe, We, Ve, ze, Ne, He = function (e, i, n, s) {
          var l;
          Re && clearTimeout(Re), Ve = !0, We = !0, e.initialLayout ? (l = e.initialLayout, e.initialLayout = null) : l = r.getThumbBoundsFn && r.getThumbBoundsFn(u);
          var d = n ? r.hideAnimationDuration : r.showAnimationDuration,
            h = function () {
              Xt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Mt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), Ve = !1
            };
          if (!d || !l || void 0 === l.x) return St("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Ot(ut, e.initialPosition), Pt(), t.style.opacity = n ? 0 : 1, Mt(1), void(d ? setTimeout(function () {
            h()
          }, d) : h());
          ! function () {
            var i = c,
              s = !a.currItem.src || a.currItem.loadError || r.showHideOpacity;
            e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, Pt()), qt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
              ...
              if (St("initialZoom" + (n ? "Out" : "In")), n) {
                var a = l.w / e.w,
                  ...
                  u = at,
                  f = function (e) {
                    1 === e ? (g = a, ut.x = l.x, ut.y = l.y - F) : (g = (a - c) * e + c, ut.x = (l.x - r.x) * e + r.x, ut.y = (l.y - F - r.y) * e + r.y), Pt(), s ? t.style.opacity = 1 - e : Mt(u - e * u)
                  };
                i ? Qt("initialZoom", 0, 1, d, o.easing.cubic.out, f, h) : (f(1), Re = setTimeout(h, d + 20))
              } else g = e.initialZoomLevel, Ot(ut, e.initialPosition), Pt(), Mt(1), s ? t.style.opacity = 1 : Mt(1), Re = setTimeout(h, d + 20)
            }, n ? 25 : 90)
          }()
        },
        Be = {},
        ...
        $e = function (t, e, i) {
          if (t.src && !t.loadError) {
            ...
            if (n && (t.vGap || (t.vGap = {
                top: 0,
                bottom: 0
              }), St("parseVerticalMargin", t)), Be.x = e.x, Be.y = e.y - t.vGap.top - t.vGap.bottom, n) {
              var o = Be.x / t.w,
                a = Be.y / t.h;
              t.fitRatio = a > o ? o : a;
              var s = r.scaleMode;
            ...
            return function (t, e, i) {
              var n = t.bounds;
              n.center.x = Math.round((Be.x - e) / 2), n.center.y = Math.round((Be.y - i) / 2) + t.vGap.top, n.max.x = e > Be.x ? Math.round(Be.x - e) : n.center.x, n.max.y = i > Be.y ? Math.round(Be.y - i) + t.vGap.top : n.center.y, n.min.x = e > Be.x ? 0 : n.center.x, n.min.y = i > Be.y ? t.vGap.top : n.center.y
      ...
      xt("Controller", {
        publicMethods: {
          ...
          initController: function () {
            o.extend(r, Ye, !0), a.items = Fe = i, ze = a.getItemAt, Ne = r.getNumItemsFn, r.loop, Ne() < 3 && (r.loop = !1), Ct("beforeChange", function (t) {
              var e, i = r.preload,
                n = null === t || t >= 0,
                o = Math.min(i[0], Ne()),
                s = Math.min(i[1], Ne());
            ...
            }), Ct("mainScrollAnimComplete", Ze), Ct("initialZoomInEnd", Ze), Ct("destroy", function () {
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), $e(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), Xe(0, l, c, n));
              else {
                if (l.loadComplete = function (i) {
                    if (s) {
                      if (t && t.index === e) {
                        if (Ue(i, !0)) return i.loadComplete = i.img = null, $e(i, dt), At(i), void(t.index === u && a.updateCurrZoomItem());
                        i.imageAppended ? !Ve && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : W.transform && (et || Ve) ? je.push({
                          item: i,
                          baseDiv: c,
                          img: i.img,
                          index: e,
                ...
                l.loading || qe(l), a.allowProgressiveImg() && (!We && W.transform ? je.push({
                  item: l,
                  baseDiv: c,
                  img: l.img,
                  index: e,
              ...
              We || e !== u ? At(l) : (tt = c.style, He(l, n || l.img)), t.el.innerHTML = "", t.el.appendChild(c)
            } else t.el.innerHTML = ""
          },
      ...
      xt("Tap", {
        publicMethods: {
          ...
          onTapStart: function (t) {
            t.length > 1 && (clearTimeout(Ge), Ge = null)
          },
          onTapRelease: function (t, e) {
            if (e && !q && !$ && !$t) {
              var i = e;
              if (Ge && (clearTimeout(Ge), Ge = null, function (t, e) {
              ...
              Ot(Je, i), Ge = setTimeout(function () {
                ti(t, e), Ge = null
              }, 300)
            }
          }
        ...
        publicMethods: {
          ...
          setupDesktopZoom: function (e) {
            ...
            Ct("bindEvents", function () {
              ...
              Ke && o.unbind(t, i, a.handleMouseWheel)
            }), a.mouseZoomedIn = !1;
            var n, r = function () {
          ...
          handleMouseWheel: function (t) {
            if (g <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || $t || Y ? t.preventDefault() : P && Math.abs(t.deltaY) > 2 && (c = !0, a.close())), !0;
            if (t.stopPropagation(), Ke.x = 0, "deltaX" in t) 1 === t.deltaMode ? (Ke.x = 18 * t.deltaX, Ke.y = 18 * t.deltaY) : (Ke.x = t.deltaX, Ke.y = t.deltaY);
            else if ("wheelDelta" in t) t.wheelDeltaX && (Ke.x = -.16 * t.wheelDeltaX), t.wheelDeltaY ? Ke.y = -.16 * t.wheelDeltaY : Ke.y = -.16 * t.wheelDelta;
            else {
      ...
      var ei, ii, ni, oi, ai, ri, si, li, ci, ui, di, hi, fi = {
          history: !0,
          galleryUID: 1
        },
        pi = function () {
        ...
        vi = function () {
          if (ni && clearTimeout(ni), $t || Y) ni = setTimeout(vi, 500);
          else {
        ...
        publicMethods: {
          initHistory: function () {
            if (o.extend(r, fi, !0), r.history) {
              di = window.location, ui = !1, ci = !1, li = !1, si = pi(), hi = "pushState" in history, si.indexOf("gid=") > -1 && (si = (si = si.split("&gid=")[0]).split("?gid=")[0]), Ct("afterChange", a.updateURL), Ct("unbindEvents", function () {
          ...
          onHashChange: function () {
            return pi() === si ? (ci = !0, void a.close()) : void(oi || (ai = !0, a.goTo(gi().pid), ai = !1))
          },
          updateURL: function () {
  ...
  function (t, e) {
    ...
    "use strict";
    return function (t, e) {
      var i, n, o, a, r, s, l, c, u, d, h, f, p, m, g, v, y, b, x = this,
        w = !1,
        k = !0,
        C = !0,
        S = {
        ...
        T = function (t) {
          ...
          for (var i, n, o = (t.target || t.srcElement).getAttribute("class") || "", a = 0; a < z.length; a++)(i = z[a]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
          if (n) {
        ...
        _ = function (e) {
          ...
          return t.shout("shareLinkClick", e, i), !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), C || D(), 1))
        },
        E = function () {
        ...
        W = function (t) {
          f !== t && (I(h, "preloader--active", !t), f = t)
        },
        V = function (t) {
          var i = t.vGap;
          if (M()) {
      ...
      x.init = function () {
        e.extend(t.options, S, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen,
          function () {
            ...
            C || D(), y && clearInterval(y), e.unbind(document, "mouseout", F), e.unbind(document, "mousemove", R), e.unbind(n, "pswpTap click", T), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
          }), d("destroy", function () {
            ...
            var t, i, o, a = function (n) {
              if (n)
                for (var a = n.length, r = 0; a > r; r++) {
                  t = n[r], i = t.className;
                  for (var s = 0; s < z.length; s++) o = z[s], i.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"))
                }
            };
            a(n.children);
          ...
          }), g.fullscreenEl && !e.features.isOldAndroid && (i || (i = x.getFullscreenAPI()), i ? (e.bind(document, i.eventK, x.updateFullscreen), x.updateFullscreen(), e.addClass(t.template, "pswp--supports-fs")) : e.removeClass(t.template, "pswp--supports-fs")), g.preloaderEl && (W(!0), d("beforeChange", function () {
        ...
        k && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), I(o, "caption--empty", !t.currItem.title)), w = !0) : w = !1, C || D(), P()
        ...
        if (!v)
          ...
          } else if (g.tapToToggleControls && (k ? x.hideControls() : x.showControls()), g.tapToClose && (e.hasClass(n, "pswp__img") || O(n))) return void t.close()
      }, x.onMouseOver = function (t) {
        var e = (t = t || window.event).target || t.srcElement;
        I(n, "ui--over-close", O(e))
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
      ...
      return this.each(function () {
        ...
        function f() {
          var r = h.scrollTop(),
            f = d,
            p = e.parent().width();
          (u.width(p), o && "string" == typeof d) && (f = t(d).offset().top - a - s);
          if (c < r) {
        ...
        h.innerHeight() > a && (h.bind("scroll", f), h.bind("load", f), h.bind("resize", f))
      })
    }
  }(jQuery),
  function t(e, i, n) {
        ...
        e.event.bind(e.ownerDocument, "keydown", function (n) {
          if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented)) {
            ...
            if (i || r) {
              ...
              l(t, "top", t.scrollTop - d), l(t, "left", t.scrollLeft + u), s(t),
                function (i, n) {
                  var o = t.scrollTop;
                  if (0 === i) {
    ...
    16: [function (t, e, i) {
      ...
      e.exports = function (t) {
        (n.env.supportsTouch || n.env.supportsIePointer) && function (t, e, i, n) {
          ...
          function p(t) {
            if (!w && e.settings.swipePropagation && f(t), !x && w && h(t)) {
              var i = d(t),
                n = {
                  pageX: i.pageX,
                  pageY: i.pageY
  ...
  function (t) {
    ...
    t(document).ready(function () {
      ...
      return this.$el = t(this), this.$document = t(document), this.SELS = {
      ...
      }, "data" === n ? this.$el.data("chips") : "options" === n ? this.$el.data("options") : (this.$el.data("options", t.extend({}, i, n)), this.init = function () {
        var e = 0;
        o.$el.each(function () {
          var i = t(this);
          if (!i.data("initialized")) {
            var n = i.data("options");
            n.data && n.data instanceof Array || (n.data = []), i.data("chips", n.data), i.data("index", e), i.data("initialized", !0), i.hasClass(o.SELS.CHIPS) || i.addClass("chips"), o.chips(i), e++
          }
        })
      }, this.handleEvents = function () {
        var e = o.SELS;
        o.$document.on("click", e.CHIPS, function (i) {
          t(i.target).find(e.INPUT).focus()
        }), o.$document.on("click", e.CHIP, function () {
          t(e.CHIP).removeClass("selected"), t(this).toggleClass("selected")
        }), o.$document.on("keydown", function (i) {
          if (!t(i.target).is("input, textarea")) {
            var n = o.$document.find(e.CHIP + e.SELECTED_CHIP),
              a = n.closest(e.CHIPS),
              r = n.siblings(e.CHIP).length,
              s = void 0;
            if (n.length) {
              ...
              if (l) {
                i.preventDefault();
                var d = a.data("index");
                s = n.index(), o.deleteChip(d, s, a);
                var h = null;
                s + 1 < r ? h = s : s !== r && s + 1 !== r || (h = r - 1), h < 0 && (h = null), null !== h && o.selectChip(d, h, a), r || a.find("input").focus()
              } else if (c) {
                if ((s = n.index() - 1) < 0) return;
                t(e.CHIP).removeClass("selected"), o.selectChip(a.data("index"), s, a)
              } else if (u) {
                if (s = n.index() + 1, t(e.CHIP).removeClass("selected"), s > r) return void a.find("input").focus();
                o.selectChip(a.data("index"), s, a)
              }
            }
          }
          ...
          var n = t(i.target),
            a = n.closest(e.CHIPS),
            r = a.data("index"),
            s = a.children(e.CHIP).length;
          if (13 === i.which) return i.preventDefault(), o.addChip(r, {
            tag: n.val()
          }, a), void n.val("");
          var l = 8 === i.keyCode || 37 === i.keyCode,
            c = "" === n.val();
          return l && c && s ? (o.selectChip(r, s - 1, a), void n.blur()) : void 0
        }), o.$document.on("click", e.CHIPS + " " + e.DELETE, function (i) {
          var n = t(i.target),
            a = n.closest(e.CHIPS),
            r = n.closest(e.CHIP);
          i.stopPropagation(), o.deleteChip(a.data("index"), r.index(), a), a.find("input").focus()
        })
        ...
        if (o.isValid(n, i)) {
          var a = o.renderChip(i);
          n.data("chips").push(i), t(a).insertBefore(n.find("input")), n.trigger("chip.add", i), o.setPlaceholder(n)
        }
      }, this.deleteChip = function (t, e, i) {
        var n = i.data("chips")[e];
        i.find(".chip").eq(e).remove(), i.data("chips").splice(e, 1), i.trigger("chip.delete", n), o.setPlaceholder(i)
  ...
  function (t) {
    ...
    (function (t) {
      ...
      function g(t) {
        d = l.window.innerWidth || document.documentElement.clientWidth, h = l.window.innerHeight || document.documentElement.clientHeight, "object" !== (void 0 === t ? "undefined" : a(t)) || "load" !== t.type && "dom-loaded" !== t.type || (p = !0)
      }
      ...
      function b() {
        if (v.length) {
          ...
          var t = p || !y || y.width !== d || y.height !== h,
            e = m || t || !y || y.y !== f;
          p = !1, m = !1, (t || e) && (v.forEach(function (i) {
      ...
      var x = !!t.ResizeObserver && new t.ResizeObserver(function (t) {
        ...
        k = function () {
          function t(e, i) {
            ...
            var o = this;
            o.instanceID = w++, o.$item = e, o.defaults = {
              type: "scroll",
              speed: .5,
              imgSrc: null,
          ...
          return o(t, [{
            key: "css",
            value: function (t, e) {
              return "string" == typeof e ? l.window.getComputedStyle(t).getPropertyValue(e) : (e.transform && u && (e[u] = e.transform), Object.keys(e).forEach(function (i) {
                t.style[i] = e[i]
              }), t)
            }
          }, {
            ...
            value: function () {
              ...
              e.position = this.image.position, this.css(this.image.$item, e), this.image.$container.appendChild(this.image.$item), this.coverImage(), this.clipContainer(), this.onScroll(!0), this.options.automaticResize && x && x.observe(this.$item), this.options.onInit && this.options.onInit.call(this), "none" !== this.css(this.$item, "background-image") && this.css(this.$item, {
            ...
            value: function () {
              ...
              v.forEach(function (e, i) {
                e.instanceID === t.instanceID && v.splice(i, 1)
              })
            }
          }, {
            key: "destroy",
            ...
            value: function () {
              var t = this.image.$container.getBoundingClientRect(),
                ...
                a = e,
                r = 0;
              return n && (o = i < 0 ? i * Math.max(e, h) : i * (e + h), i > 1 ? a = Math.abs(o - h) : i < 0 ? a = o / i + Math.abs(o) : a += Math.abs(h - e) * (1 - i), o /= 2), this.parallaxScrollDistance = o, r = n ? (h - a) / 2 : (e - a) / 2, this.css(this.image.$item, {
                height: a + "px",
                marginTop: r + "px",
            ...
            value: function (t) {
              var e = this.$item.getBoundingClientRect(),
                ...
                o = {},
                a = e;
              if (this.options.elementInViewport && (a = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = a.bottom >= 0 && a.right >= 0 && a.top <= h && a.left <= d, t || this.isElementInViewport) {
                var r = Math.max(0, i),
                  s = Math.max(0, n + i),
                  l = Math.max(0, -i),
                  c = Math.max(0, i + n - h),
        ...
        C = function (t) {
          ...
          for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, r = void 0; o < n; o++)
            if ("object" === (void 0 === e ? "undefined" : a(e)) || void 0 === e ? t[o].jarallax || (t[o].jarallax = new k(t[o], e)) : t[o].jarallax && (r = t[o].jarallax[e].apply(t[o].jarallax, i)), void 0 !== r) return r;
          return t
        };
      C.constructor = k, e.default = C
    }).call(e, i(2))
  }, function (t, e, i) {
    "use strict";
    var n = i(0),
  ...
  function (t) {
    ...
    return t = $.extend({
      ...
      var e = $(this),
        i = void 0,
        n = t.data;
      Object.keys(n).length && (i = $('<ul class="mdb-autocomplete-wrap"></ul>')).insertAfter($(this)), e.on("keyup", function (t) {
        var o = e.val();
        if (i.empty(), o.length)
          for (var a in n)
